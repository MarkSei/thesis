...
#define MAVLINK_MSG_ID_HIL_STATE_LEN 80
#define MAVLINK_MSG_ID_HIL_STATE_MIN_LEN 80
#define MAVLINK_MSG_ID_90_LEN 80
#define MAVLINK_MSG_ID_90_MIN_LEN 80

#define MAVLINK_MSG_ID_HIL_STATE_CRC 46
#define MAVLINK_MSG_ID_90_CRC 46

#define MAVLINK_MSG_HIL_STATE_FIELD_PADDING_LEN 8
#define MAVLINK_MSG_HIL_STATE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_STATE { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_state_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 8, 56, offsetof(mavlink_hil_state_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_hil_state_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_STATE { \
                               ...
                               uint64_t time_usec, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed, int32_t lat, int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, int16_t xacc, int16_t yacc, int16_t zacc)
{
    ...
    _mav_put_uint8_t_array(buf, 56, NULL, 8);
...
/**
 * @brief Get field padding from hil_state message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_state_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 8,  56);
}

/**
 * @brief Get field tag from hil_state message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_state_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_hil_state_decode(const mavlink_message_t* msg, mavlink_hil_state_t* hil_state)
{
    ...
    mavlink_msg_hil_state_get_padding(msg, hil_state->padding);
    mavlink_msg_hil_state_get_tag(msg, hil_state->tag);
#else
