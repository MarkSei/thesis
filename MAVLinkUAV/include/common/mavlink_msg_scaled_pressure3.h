...
#define MAVLINK_MSG_ID_SCALED_PRESSURE3_LEN 32
#define MAVLINK_MSG_ID_SCALED_PRESSURE3_MIN_LEN 32
#define MAVLINK_MSG_ID_143_LEN 32
#define MAVLINK_MSG_ID_143_MIN_LEN 32

#define MAVLINK_MSG_ID_SCALED_PRESSURE3_CRC 91
#define MAVLINK_MSG_ID_143_CRC 91

#define MAVLINK_MSG_SCALED_PRESSURE3_FIELD_PADDING_LEN 2
#define MAVLINK_MSG_SCALED_PRESSURE3_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SCALED_PRESSURE3 { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_scaled_pressure3_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 2, 14, offsetof(mavlink_scaled_pressure3_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_scaled_pressure3_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SCALED_PRESSURE3 { \
                               ...
                               uint32_t time_boot_ms, float press_abs, float press_diff, int16_t temperature)
{
    ...
    _mav_put_uint8_t_array(buf, 14, NULL, 2);
...
/**
 * @brief Get field padding from scaled_pressure3 message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_scaled_pressure3_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 2,  14);
}

/**
 * @brief Get field tag from scaled_pressure3 message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_scaled_pressure3_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_scaled_pressure3_decode(const mavlink_message_t* msg, mavlink_scaled_pressure3_t* scaled_pressure3)
{
    ...
    mavlink_msg_scaled_pressure3_get_padding(msg, scaled_pressure3->padding);
    mavlink_msg_scaled_pressure3_get_tag(msg, scaled_pressure3->tag);
#else
