...
#define MAVLINK_MSG_ID_PROTOCOL_VERSION_LEN 32
#define MAVLINK_MSG_ID_PROTOCOL_VERSION_MIN_LEN 32
#define MAVLINK_MSG_ID_300_LEN 32
#define MAVLINK_MSG_ID_300_MIN_LEN 32

#define MAVLINK_MSG_ID_PROTOCOL_VERSION_CRC 221
#define MAVLINK_MSG_ID_300_CRC 221
...
#define MAVLINK_MSG_PROTOCOL_VERSION_FIELD_PADDING_LEN 10
...
#define MAVLINK_MESSAGE_INFO_PROTOCOL_VERSION { \
    ...
    {  { "version", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_protocol_version_t, version) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 22, offsetof(mavlink_protocol_version_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PROTOCOL_VERSION { \
...
/**
 * @brief Get field padding from protocol_version message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_protocol_version_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_protocol_version_decode(const mavlink_message_t* msg, mavlink_protocol_version_t* protocol_version)
{
    ...
    mavlink_msg_protocol_version_get_padding(msg, protocol_version->padding);
#else
