...
#define MAVLINK_MSG_ID_MISSION_SET_CURRENT_LEN 32
#define MAVLINK_MSG_ID_MISSION_SET_CURRENT_MIN_LEN 32
#define MAVLINK_MSG_ID_41_LEN 32
#define MAVLINK_MSG_ID_41_MIN_LEN 32

#define MAVLINK_MSG_ID_MISSION_SET_CURRENT_CRC 192
#define MAVLINK_MSG_ID_41_CRC 192

#define MAVLINK_MSG_MISSION_SET_CURRENT_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_MISSION_SET_CURRENT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MISSION_SET_CURRENT { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mission_set_current_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 4, offsetof(mavlink_mission_set_current_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_mission_set_current_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_SET_CURRENT { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint16_t seq)
{
    ...
    _mav_put_uint8_t_array(buf, 4, NULL, 12);
...
/**
 * @brief Get field padding from mission_set_current message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_set_current_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  4);
}

/**
 * @brief Get field tag from mission_set_current message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_mission_set_current_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_mission_set_current_decode(const mavlink_message_t* msg, mavlink_mission_set_current_t* mission_set_current)
{
    ...
    mavlink_msg_mission_set_current_get_padding(msg, mission_set_current->padding);
    mavlink_msg_mission_set_current_get_tag(msg, mission_set_current->tag);
#else
