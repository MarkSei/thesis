...
#define MAVLINK_MSG_ID_MANUAL_CONTROL_MIN_LEN 32
#define MAVLINK_MSG_ID_69_LEN 32
#define MAVLINK_MSG_ID_69_MIN_LEN 32

#define MAVLINK_MSG_ID_MANUAL_CONTROL_CRC 38
#define MAVLINK_MSG_ID_69_CRC 38

#define MAVLINK_MSG_MANUAL_CONTROL_FIELD_PADDING_LEN 5
#define MAVLINK_MSG_MANUAL_CONTROL_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MANUAL_CONTROL { \
    ...
    {  { "target", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_manual_control_t, target) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 5, 11, offsetof(mavlink_manual_control_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_manual_control_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MANUAL_CONTROL { \
                               ...
                               uint8_t target, int16_t x, int16_t y, int16_t z, int16_t r, uint16_t buttons)
{
    ...
    _mav_put_uint8_t_array(buf, 11, NULL, 5);
...
/**
 * @brief Get field padding from manual_control message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_manual_control_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 5,  11);
}

/**
 * @brief Get field tag from manual_control message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_manual_control_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_manual_control_decode(const mavlink_message_t* msg, mavlink_manual_control_t* manual_control)
{
    ...
    mavlink_msg_manual_control_get_padding(msg, manual_control->padding);
    mavlink_msg_manual_control_get_tag(msg, manual_control->tag);
#else
