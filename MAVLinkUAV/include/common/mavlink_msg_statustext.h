...
#define MAVLINK_MSG_ID_STATUSTEXT_LEN 80
#define MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN 80
#define MAVLINK_MSG_ID_253_LEN 80
#define MAVLINK_MSG_ID_253_MIN_LEN 80

#define MAVLINK_MSG_ID_STATUSTEXT_CRC 46
#define MAVLINK_MSG_ID_253_CRC 46

#define MAVLINK_MSG_STATUSTEXT_FIELD_TEXT_LEN 50
#define MAVLINK_MSG_STATUSTEXT_FIELD_PADDING_LEN 13
#define MAVLINK_MSG_STATUSTEXT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_STATUSTEXT { \
    ...
    {  { "severity", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_statustext_t, severity) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 51, offsetof(mavlink_statustext_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_statustext_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_STATUSTEXT { \
...
/**
 * @brief Get field padding from statustext message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_statustext_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  51);
}

/**
 * @brief Get field tag from statustext message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_statustext_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_statustext_decode(const mavlink_message_t* msg, mavlink_statustext_t* statustext)
{
    ...
    mavlink_msg_statustext_get_padding(msg, statustext->padding);
    mavlink_msg_statustext_get_tag(msg, statustext->tag);
#else
