...
#define MAVLINK_MSG_ID_GPS_STATUS_LEN 128
#define MAVLINK_MSG_ID_GPS_STATUS_MIN_LEN 128
#define MAVLINK_MSG_ID_25_LEN 128
#define MAVLINK_MSG_ID_25_MIN_LEN 128

#define MAVLINK_MSG_ID_GPS_STATUS_CRC 10
#define MAVLINK_MSG_ID_25_CRC 10
...
#define MAVLINK_MSG_GPS_STATUS_FIELD_PADDING_LEN 11
#define MAVLINK_MSG_GPS_STATUS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GPS_STATUS { \
    ...
    {  { "satellites_visible", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_gps_status_t, satellites_visible) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 101, offsetof(mavlink_gps_status_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 112, offsetof(mavlink_gps_status_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS_STATUS { \
                               ...
                               uint8_t satellites_visible, const uint8_t *satellite_prn, const uint8_t *satellite_used, const uint8_t *satellite_elevation, const uint8_t *satellite_azimuth, const uint8_t *satellite_snr)
{
    ...
    _mav_put_uint8_t_array(buf, 101, NULL, 11);
...
/**
 * @brief Get field padding from gps_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  101);
}

/**
 * @brief Get field tag from gps_status message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_gps_status_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_gps_status_decode(const mavlink_message_t* msg, mavlink_gps_status_t* gps_status)
{
    ...
    mavlink_msg_gps_status_get_padding(msg, gps_status->padding);
    mavlink_msg_gps_status_get_tag(msg, gps_status->tag);
#else
