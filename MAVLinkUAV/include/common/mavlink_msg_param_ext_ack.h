...
#define MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN 160
#define MAVLINK_MSG_ID_PARAM_EXT_ACK_MIN_LEN 160
#define MAVLINK_MSG_ID_324_LEN 160
#define MAVLINK_MSG_ID_324_MIN_LEN 160

#define MAVLINK_MSG_ID_PARAM_EXT_ACK_CRC 246
#define MAVLINK_MSG_ID_324_CRC 246

#define MAVLINK_MSG_PARAM_EXT_ACK_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_EXT_ACK_FIELD_PARAM_VALUE_LEN 128
#define MAVLINK_MSG_PARAM_EXT_ACK_FIELD_PADDING_LEN 14
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_ACK { \
    ...
    {  { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 0, offsetof(mavlink_param_ext_ack_t, param_id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 146, offsetof(mavlink_param_ext_ack_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_ACK { \
                               ...
                               const char *param_id, const char *param_value, uint8_t param_type, uint8_t param_result)
{
    ...
    _mav_put_uint8_t_array(buf, 146, NULL, 14);
...
/**
 * @brief Get field padding from param_ext_ack message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_ext_ack_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  146);
}
...
static inline void mavlink_msg_param_ext_ack_decode(const mavlink_message_t* msg, mavlink_param_ext_ack_t* param_ext_ack)
{
    ...
    mavlink_msg_param_ext_ack_get_padding(msg, param_ext_ack->padding);
#else
