...
#define MAVLINK_MSG_ID_RAW_IMU_LEN 48
#define MAVLINK_MSG_ID_RAW_IMU_MIN_LEN 48
#define MAVLINK_MSG_ID_27_LEN 48
#define MAVLINK_MSG_ID_27_MIN_LEN 48

#define MAVLINK_MSG_ID_RAW_IMU_CRC 186
#define MAVLINK_MSG_ID_27_CRC 186

#define MAVLINK_MSG_RAW_IMU_FIELD_PADDING_LEN 6
#define MAVLINK_MSG_RAW_IMU_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_RAW_IMU { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_raw_imu_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 6, 26, offsetof(mavlink_raw_imu_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_raw_imu_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RAW_IMU { \
...
/**
 * @brief Get field padding from raw_imu message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_raw_imu_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 6,  26);
}

/**
 * @brief Get field tag from raw_imu message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_raw_imu_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_raw_imu_decode(const mavlink_message_t* msg, mavlink_raw_imu_t* raw_imu)
{
    ...
    mavlink_msg_raw_imu_get_padding(msg, raw_imu->padding);
    mavlink_msg_raw_imu_get_tag(msg, raw_imu->tag);
#else
