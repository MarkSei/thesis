...
#define MAVLINK_MSG_ID_RC_CHANNELS_LEN 64
#define MAVLINK_MSG_ID_RC_CHANNELS_MIN_LEN 64
#define MAVLINK_MSG_ID_65_LEN 64
#define MAVLINK_MSG_ID_65_MIN_LEN 64

#define MAVLINK_MSG_ID_RC_CHANNELS_CRC 24
#define MAVLINK_MSG_ID_65_CRC 24

#define MAVLINK_MSG_RC_CHANNELS_FIELD_PADDING_LEN 6
#define MAVLINK_MSG_RC_CHANNELS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_rc_channels_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 6, 42, offsetof(mavlink_rc_channels_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_rc_channels_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS { \
...
/**
 * @brief Get field padding from rc_channels message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_rc_channels_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 6,  42);
}

/**
 * @brief Get field tag from rc_channels message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_rc_channels_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_rc_channels_decode(const mavlink_message_t* msg, mavlink_rc_channels_t* rc_channels)
{
    ...
    mavlink_msg_rc_channels_get_padding(msg, rc_channels->padding);
    mavlink_msg_rc_channels_get_tag(msg, rc_channels->tag);
#else
