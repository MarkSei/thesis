...
#define MAVLINK_MSG_ID_ATTITUDE_TARGET_LEN 64
#define MAVLINK_MSG_ID_ATTITUDE_TARGET_MIN_LEN 64
#define MAVLINK_MSG_ID_83_LEN 64
#define MAVLINK_MSG_ID_83_MIN_LEN 64
...
#define MAVLINK_MSG_ATTITUDE_TARGET_FIELD_PADDING_LEN 11
#define MAVLINK_MSG_ATTITUDE_TARGET_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE_TARGET { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_attitude_target_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 37, offsetof(mavlink_attitude_target_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_attitude_target_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ATTITUDE_TARGET { \
...
/**
 * @brief Get field padding from attitude_target message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_attitude_target_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  37);
}

/**
 * @brief Get field tag from attitude_target message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_attitude_target_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_attitude_target_decode(const mavlink_message_t* msg, mavlink_attitude_target_t* attitude_target)
{
    ...
    mavlink_msg_attitude_target_get_padding(msg, attitude_target->padding);
    mavlink_msg_attitude_target_get_tag(msg, attitude_target->tag);
#else
