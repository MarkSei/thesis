...
#define MAVLINK_MSG_ID_SETUP_SIGNING_LEN 48
#define MAVLINK_MSG_ID_SETUP_SIGNING_MIN_LEN 48
#define MAVLINK_MSG_ID_256_LEN 48
#define MAVLINK_MSG_ID_256_MIN_LEN 48

#define MAVLINK_MSG_ID_SETUP_SIGNING_CRC 81
#define MAVLINK_MSG_ID_256_CRC 81

#define MAVLINK_MSG_SETUP_SIGNING_FIELD_SECRET_KEY_LEN 32
#define MAVLINK_MSG_SETUP_SIGNING_FIELD_PADDING_LEN 6
...
#define MAVLINK_MESSAGE_INFO_SETUP_SIGNING { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_setup_signing_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 6, 42, offsetof(mavlink_setup_signing_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SETUP_SIGNING { \
...
/**
 * @brief Get field padding from setup_signing message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_setup_signing_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_setup_signing_decode(const mavlink_message_t* msg, mavlink_setup_signing_t* setup_signing)
{
    ...
    mavlink_msg_setup_signing_get_padding(msg, setup_signing->padding);
#else
