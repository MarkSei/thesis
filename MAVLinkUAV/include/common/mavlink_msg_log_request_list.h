...
#define MAVLINK_MSG_ID_LOG_REQUEST_LIST_LEN 32
#define MAVLINK_MSG_ID_LOG_REQUEST_LIST_MIN_LEN 32
#define MAVLINK_MSG_ID_117_LEN 32
#define MAVLINK_MSG_ID_117_MIN_LEN 32

#define MAVLINK_MSG_ID_LOG_REQUEST_LIST_CRC 43
#define MAVLINK_MSG_ID_117_CRC 43

#define MAVLINK_MSG_LOG_REQUEST_LIST_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_LOG_REQUEST_LIST_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_LIST { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_log_request_list_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 6, offsetof(mavlink_log_request_list_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_log_request_list_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_LIST { \
...
/**
 * @brief Get field padding from log_request_list message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_log_request_list_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  6);
}

/**
 * @brief Get field tag from log_request_list message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_log_request_list_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_log_request_list_decode(const mavlink_message_t* msg, mavlink_log_request_list_t* log_request_list)
{
    ...
    mavlink_msg_log_request_list_get_padding(msg, log_request_list->padding);
    mavlink_msg_log_request_list_get_tag(msg, log_request_list->tag);
#else
