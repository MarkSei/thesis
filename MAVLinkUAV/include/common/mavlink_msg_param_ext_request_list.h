...
#define MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_LEN 16
#define MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_MIN_LEN 16
#define MAVLINK_MSG_ID_321_LEN 16
#define MAVLINK_MSG_ID_321_MIN_LEN 16

#define MAVLINK_MSG_ID_PARAM_EXT_REQUEST_LIST_CRC 229
#define MAVLINK_MSG_ID_321_CRC 229

#define MAVLINK_MSG_PARAM_EXT_REQUEST_LIST_FIELD_PADDING_LEN 14
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_REQUEST_LIST { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_param_ext_request_list_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 2, offsetof(mavlink_param_ext_request_list_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_REQUEST_LIST { \
...
/**
 * @brief Get field padding from param_ext_request_list message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_ext_request_list_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_param_ext_request_list_decode(const mavlink_message_t* msg, mavlink_param_ext_request_list_t* param_ext_request_list)
{
    ...
    mavlink_msg_param_ext_request_list_get_padding(msg, param_ext_request_list->padding);
#else
