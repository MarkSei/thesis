...
#define MAVLINK_MSG_ID_MANUAL_SETPOINT_LEN 48
#define MAVLINK_MSG_ID_MANUAL_SETPOINT_MIN_LEN 48
#define MAVLINK_MSG_ID_81_LEN 48
#define MAVLINK_MSG_ID_81_MIN_LEN 48

#define MAVLINK_MSG_ID_MANUAL_SETPOINT_CRC 41
#define MAVLINK_MSG_ID_81_CRC 41

#define MAVLINK_MSG_MANUAL_SETPOINT_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_MANUAL_SETPOINT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MANUAL_SETPOINT { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_manual_setpoint_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 22, offsetof(mavlink_manual_setpoint_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_manual_setpoint_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MANUAL_SETPOINT { \
...
/**
 * @brief Get field padding from manual_setpoint message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_manual_setpoint_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  22);
}

/**
 * @brief Get field tag from manual_setpoint message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_manual_setpoint_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_manual_setpoint_decode(const mavlink_message_t* msg, mavlink_manual_setpoint_t* manual_setpoint)
{
    ...
    mavlink_msg_manual_setpoint_get_padding(msg, manual_setpoint->padding);
    mavlink_msg_manual_setpoint_get_tag(msg, manual_setpoint->tag);
#else
