...
#define MAVLINK_MSG_ID_BATTERY_STATUS_LEN 64
#define MAVLINK_MSG_ID_BATTERY_STATUS_MIN_LEN 64
#define MAVLINK_MSG_ID_147_LEN 64
#define MAVLINK_MSG_ID_147_MIN_LEN 64

#define MAVLINK_MSG_ID_BATTERY_STATUS_CRC 98
#define MAVLINK_MSG_ID_147_CRC 98

#define MAVLINK_MSG_BATTERY_STATUS_FIELD_VOLTAGES_LEN 10
#define MAVLINK_MSG_BATTERY_STATUS_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_BATTERY_STATUS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_BATTERY_STATUS { \
    ...
    {  { "id", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_battery_status_t, id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 36, offsetof(mavlink_battery_status_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_battery_status_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_BATTERY_STATUS { \
                               ...
                               uint8_t id, uint8_t battery_function, uint8_t type, int16_t temperature, const uint16_t *voltages, int16_t current_battery, int32_t current_consumed, int32_t energy_consumed, int8_t battery_remaining)
{
    ...
    _mav_put_uint8_t_array(buf, 36, NULL, 12);
...
/**
 * @brief Get field padding from battery_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_battery_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  36);
}

/**
 * @brief Get field tag from battery_status message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_battery_status_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_battery_status_decode(const mavlink_message_t* msg, mavlink_battery_status_t* battery_status)
{
    ...
    mavlink_msg_battery_status_get_padding(msg, battery_status->padding);
    mavlink_msg_battery_status_get_tag(msg, battery_status->tag);
#else
