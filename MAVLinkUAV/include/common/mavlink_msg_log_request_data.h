...
#define MAVLINK_MSG_ID_LOG_REQUEST_DATA_LEN 32
#define MAVLINK_MSG_ID_LOG_REQUEST_DATA_MIN_LEN 32
#define MAVLINK_MSG_ID_119_LEN 32
#define MAVLINK_MSG_ID_119_MIN_LEN 32

#define MAVLINK_MSG_ID_LOG_REQUEST_DATA_CRC 232
#define MAVLINK_MSG_ID_119_CRC 232

#define MAVLINK_MSG_LOG_REQUEST_DATA_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_LOG_REQUEST_DATA_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_DATA { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_log_request_data_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 12, offsetof(mavlink_log_request_data_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_log_request_data_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOG_REQUEST_DATA { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint16_t id, uint32_t ofs, uint32_t count)
{
    ...
    _mav_put_uint8_t_array(buf, 12, NULL, 4);
...
/**
 * @brief Get field padding from log_request_data message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_log_request_data_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  12);
}

/**
 * @brief Get field tag from log_request_data message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_log_request_data_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_log_request_data_decode(const mavlink_message_t* msg, mavlink_log_request_data_t* log_request_data)
{
    ...
    mavlink_msg_log_request_data_get_padding(msg, log_request_data->padding);
    mavlink_msg_log_request_data_get_tag(msg, log_request_data->tag);
#else
