...
#define MAVLINK_MSG_ID_HIL_GPS_LEN 64
#define MAVLINK_MSG_ID_HIL_GPS_MIN_LEN 64
#define MAVLINK_MSG_ID_113_LEN 64
#define MAVLINK_MSG_ID_113_MIN_LEN 64

#define MAVLINK_MSG_ID_HIL_GPS_CRC 154
#define MAVLINK_MSG_ID_113_CRC 154

#define MAVLINK_MSG_HIL_GPS_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_HIL_GPS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_GPS { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_gps_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 36, offsetof(mavlink_hil_gps_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_hil_gps_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_GPS { \
...
/**
 * @brief Get field padding from hil_gps message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_gps_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  36);
}

/**
 * @brief Get field tag from hil_gps message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_gps_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_hil_gps_decode(const mavlink_message_t* msg, mavlink_hil_gps_t* hil_gps)
{
    ...
    mavlink_msg_hil_gps_get_padding(msg, hil_gps->padding);
    mavlink_msg_hil_gps_get_tag(msg, hil_gps->tag);
#else
