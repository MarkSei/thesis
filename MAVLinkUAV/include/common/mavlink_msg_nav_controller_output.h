...
#define MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_LEN 48
#define MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_MIN_LEN 48
#define MAVLINK_MSG_ID_62_LEN 48
#define MAVLINK_MSG_ID_62_MIN_LEN 48

#define MAVLINK_MSG_ID_NAV_CONTROLLER_OUTPUT_CRC 109
#define MAVLINK_MSG_ID_62_CRC 109

#define MAVLINK_MSG_NAV_CONTROLLER_OUTPUT_FIELD_PADDING_LEN 6
#define MAVLINK_MSG_NAV_CONTROLLER_OUTPUT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_NAV_CONTROLLER_OUTPUT { \
    ...
    {  { "nav_roll", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_nav_controller_output_t, nav_roll) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 6, 26, offsetof(mavlink_nav_controller_output_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_nav_controller_output_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NAV_CONTROLLER_OUTPUT { \
                               ...
                               float nav_roll, float nav_pitch, int16_t nav_bearing, int16_t target_bearing, uint16_t wp_dist, float alt_error, float aspd_error, float xtrack_error)
{
    ...
    _mav_put_uint8_t_array(buf, 26, NULL, 6);
...
/**
 * @brief Get field padding from nav_controller_output message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_nav_controller_output_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 6,  26);
}

/**
 * @brief Get field tag from nav_controller_output message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_nav_controller_output_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_nav_controller_output_decode(const mavlink_message_t* msg, mavlink_nav_controller_output_t* nav_controller_output)
{
    ...
    mavlink_msg_nav_controller_output_get_padding(msg, nav_controller_output->padding);
    mavlink_msg_nav_controller_output_get_tag(msg, nav_controller_output->tag);
#else
