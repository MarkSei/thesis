...
#define MAVLINK_MSG_ID_POSITION_TARGET_LOCAL_NED_LEN 80
#define MAVLINK_MSG_ID_POSITION_TARGET_LOCAL_NED_MIN_LEN 80
#define MAVLINK_MSG_ID_85_LEN 80
#define MAVLINK_MSG_ID_85_MIN_LEN 80

#define MAVLINK_MSG_ID_POSITION_TARGET_LOCAL_NED_CRC 124
#define MAVLINK_MSG_ID_85_CRC 124

#define MAVLINK_MSG_POSITION_TARGET_LOCAL_NED_FIELD_PADDING_LEN 13
#define MAVLINK_MSG_POSITION_TARGET_LOCAL_NED_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_POSITION_TARGET_LOCAL_NED { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_position_target_local_ned_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 51, offsetof(mavlink_position_target_local_ned_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_position_target_local_ned_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_POSITION_TARGET_LOCAL_NED { \
...
/**
 * @brief Get field padding from position_target_local_ned message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_position_target_local_ned_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  51);
}

/**
 * @brief Get field tag from position_target_local_ned message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_position_target_local_ned_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_position_target_local_ned_decode(const mavlink_message_t* msg, mavlink_position_target_local_ned_t* position_target_local_ned)
{
    ...
    mavlink_msg_position_target_local_ned_get_padding(msg, position_target_local_ned->padding);
    mavlink_msg_position_target_local_ned_get_tag(msg, position_target_local_ned->tag);
#else
