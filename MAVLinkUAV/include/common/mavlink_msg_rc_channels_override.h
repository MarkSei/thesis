...
#define MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE_LEN 48
#define MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE_MIN_LEN 48
#define MAVLINK_MSG_ID_70_LEN 48
#define MAVLINK_MSG_ID_70_MIN_LEN 48

#define MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE_CRC 104
#define MAVLINK_MSG_ID_70_CRC 104

#define MAVLINK_MSG_RC_CHANNELS_OVERRIDE_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_RC_CHANNELS_OVERRIDE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_OVERRIDE { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_rc_channels_override_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 18, offsetof(mavlink_rc_channels_override_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_rc_channels_override_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_OVERRIDE { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint16_t chan1_raw, uint16_t chan2_raw, uint16_t chan3_raw, uint16_t chan4_raw, uint16_t chan5_raw, uint16_t chan6_raw, uint16_t chan7_raw, uint16_t chan8_raw)
{
    ...
    _mav_put_uint8_t_array(buf, 18, NULL, 14);
...
/**
 * @brief Get field padding from rc_channels_override message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_rc_channels_override_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  18);
}

/**
 * @brief Get field tag from rc_channels_override message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_rc_channels_override_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_rc_channels_override_decode(const mavlink_message_t* msg, mavlink_rc_channels_override_t* rc_channels_override)
{
    ...
    mavlink_msg_rc_channels_override_get_padding(msg, rc_channels_override->padding);
    mavlink_msg_rc_channels_override_get_tag(msg, rc_channels_override->tag);
#else
