...
#define MAVLINK_MSG_ID_HEARTBEAT_CRC 32
...
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
    ...
    {  { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_heartbeat_t, type) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 9, offsetof(mavlink_heartbeat_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_heartbeat_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
