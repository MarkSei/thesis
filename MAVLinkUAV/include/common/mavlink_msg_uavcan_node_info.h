...
#define MAVLINK_MSG_ID_UAVCAN_NODE_INFO_LEN 128
#define MAVLINK_MSG_ID_UAVCAN_NODE_INFO_MIN_LEN 128
#define MAVLINK_MSG_ID_311_LEN 128
#define MAVLINK_MSG_ID_311_MIN_LEN 128

#define MAVLINK_MSG_ID_UAVCAN_NODE_INFO_CRC 229
#define MAVLINK_MSG_ID_311_CRC 229

#define MAVLINK_MSG_UAVCAN_NODE_INFO_FIELD_NAME_LEN 80
#define MAVLINK_MSG_UAVCAN_NODE_INFO_FIELD_HW_UNIQUE_ID_LEN 16
#define MAVLINK_MSG_UAVCAN_NODE_INFO_FIELD_PADDING_LEN 12
...
#define MAVLINK_MESSAGE_INFO_UAVCAN_NODE_INFO { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_uavcan_node_info_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 116, offsetof(mavlink_uavcan_node_info_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_UAVCAN_NODE_INFO { \
                               ...
                               uint64_t time_usec, uint32_t uptime_sec, const char *name, uint8_t hw_version_major, uint8_t hw_version_minor, const uint8_t *hw_unique_id, uint8_t sw_version_major, uint8_t sw_version_minor, uint32_t sw_vcs_commit)
{
    ...
    _mav_put_uint8_t_array(buf, 116, NULL, 12);
...
/**
 * @brief Get field padding from uavcan_node_info message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_uavcan_node_info_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  116);
}
...
static inline void mavlink_msg_uavcan_node_info_decode(const mavlink_message_t* msg, mavlink_uavcan_node_info_t* uavcan_node_info)
{
    ...
    mavlink_msg_uavcan_node_info_get_padding(msg, uavcan_node_info->padding);
#else
