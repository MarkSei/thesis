...
#define MAVLINK_MSG_ID_DATA_STREAM_LEN 32
#define MAVLINK_MSG_ID_DATA_STREAM_MIN_LEN 32
#define MAVLINK_MSG_ID_67_LEN 32
#define MAVLINK_MSG_ID_67_MIN_LEN 32

#define MAVLINK_MSG_ID_DATA_STREAM_CRC 222
#define MAVLINK_MSG_ID_67_CRC 222

#define MAVLINK_MSG_DATA_STREAM_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_DATA_STREAM_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_DATA_STREAM { \
    ...
    {  { "stream_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_data_stream_t, stream_id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 4, offsetof(mavlink_data_stream_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_data_stream_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_DATA_STREAM { \
...
/**
 * @brief Get field padding from data_stream message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_data_stream_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  4);
}

/**
 * @brief Get field tag from data_stream message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_data_stream_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_data_stream_decode(const mavlink_message_t* msg, mavlink_data_stream_t* data_stream)
{
    ...
    mavlink_msg_data_stream_get_padding(msg, data_stream->padding);
    mavlink_msg_data_stream_get_tag(msg, data_stream->tag);
#else
