...
#define MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_LEN 64
#define MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_MIN_LEN 64
#define MAVLINK_MSG_ID_104_LEN 64
#define MAVLINK_MSG_ID_104_MIN_LEN 64

#define MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_CRC 217
#define MAVLINK_MSG_ID_104_CRC 217

#define MAVLINK_MSG_VICON_POSITION_ESTIMATE_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_VICON_POSITION_ESTIMATE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_VICON_POSITION_ESTIMATE { \
    ...
    {  { "usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_vicon_position_estimate_t, usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_vicon_position_estimate_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_vicon_position_estimate_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_VICON_POSITION_ESTIMATE { \
...
/**
 * @brief Get field padding from vicon_position_estimate message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_vicon_position_estimate_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  32);
}

/**
 * @brief Get field tag from vicon_position_estimate message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_vicon_position_estimate_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_vicon_position_estimate_decode(const mavlink_message_t* msg, mavlink_vicon_position_estimate_t* vicon_position_estimate)
{
    ...
    mavlink_msg_vicon_position_estimate_get_padding(msg, vicon_position_estimate->padding);
    mavlink_msg_vicon_position_estimate_get_tag(msg, vicon_position_estimate->tag);
#else
