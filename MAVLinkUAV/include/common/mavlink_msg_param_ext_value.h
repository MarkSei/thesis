...
#define MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN 160
#define MAVLINK_MSG_ID_PARAM_EXT_VALUE_MIN_LEN 160
#define MAVLINK_MSG_ID_322_LEN 160
#define MAVLINK_MSG_ID_322_MIN_LEN 160

#define MAVLINK_MSG_ID_PARAM_EXT_VALUE_CRC 219
#define MAVLINK_MSG_ID_322_CRC 219

#define MAVLINK_MSG_PARAM_EXT_VALUE_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_EXT_VALUE_FIELD_PARAM_VALUE_LEN 128
#define MAVLINK_MSG_PARAM_EXT_VALUE_FIELD_PADDING_LEN 11
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_VALUE { \
    ...
    {  { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 4, offsetof(mavlink_param_ext_value_t, param_id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 149, offsetof(mavlink_param_ext_value_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_VALUE { \
                               ...
                               const char *param_id, const char *param_value, uint8_t param_type, uint16_t param_count, uint16_t param_index)
{
    ...
    _mav_put_uint8_t_array(buf, 149, NULL, 11);
...
/**
 * @brief Get field padding from param_ext_value message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_ext_value_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  149);
}
...
static inline void mavlink_msg_param_ext_value_decode(const mavlink_message_t* msg, mavlink_param_ext_value_t* param_ext_value)
{
    ...
    mavlink_msg_param_ext_value_get_padding(msg, param_ext_value->padding);
#else
