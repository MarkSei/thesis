...
#define MAVLINK_MSG_ID_SET_MODE_LEN 32
#define MAVLINK_MSG_ID_SET_MODE_MIN_LEN 32
#define MAVLINK_MSG_ID_11_LEN 32
#define MAVLINK_MSG_ID_11_MIN_LEN 32

#define MAVLINK_MSG_ID_SET_MODE_CRC 196
#define MAVLINK_MSG_ID_11_CRC 196

#define MAVLINK_MSG_SET_MODE_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_SET_MODE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SET_MODE { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_set_mode_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 6, offsetof(mavlink_set_mode_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_set_mode_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_MODE { \
...
/**
 * @brief Get field padding from set_mode message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_set_mode_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  6);
}

/**
 * @brief Get field tag from set_mode message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_set_mode_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_set_mode_decode(const mavlink_message_t* msg, mavlink_set_mode_t* set_mode)
{
    ...
    mavlink_msg_set_mode_get_padding(msg, set_mode->padding);
    mavlink_msg_set_mode_get_tag(msg, set_mode->tag);
#else
