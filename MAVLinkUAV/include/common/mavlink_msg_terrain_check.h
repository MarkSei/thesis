...
#define MAVLINK_MSG_ID_TERRAIN_CHECK_LEN 32
#define MAVLINK_MSG_ID_TERRAIN_CHECK_MIN_LEN 32
#define MAVLINK_MSG_ID_135_LEN 32
#define MAVLINK_MSG_ID_135_MIN_LEN 32

#define MAVLINK_MSG_ID_TERRAIN_CHECK_CRC 97
#define MAVLINK_MSG_ID_135_CRC 97

#define MAVLINK_MSG_TERRAIN_CHECK_FIELD_PADDING_LEN 8
#define MAVLINK_MSG_TERRAIN_CHECK_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_TERRAIN_CHECK { \
    ...
    {  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_terrain_check_t, lat) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 8, 8, offsetof(mavlink_terrain_check_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_terrain_check_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_CHECK { \
                               ...
                               int32_t lat, int32_t lon)
{
    ...
    _mav_put_uint8_t_array(buf, 8, NULL, 8);
...
/**
 * @brief Get field padding from terrain_check message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_terrain_check_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 8,  8);
}

/**
 * @brief Get field tag from terrain_check message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_terrain_check_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_terrain_check_decode(const mavlink_message_t* msg, mavlink_terrain_check_t* terrain_check)
{
    ...
    mavlink_msg_terrain_check_get_padding(msg, terrain_check->padding);
    mavlink_msg_terrain_check_get_tag(msg, terrain_check->tag);
#else
