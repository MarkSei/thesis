...
#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_LEN 96
#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_MIN_LEN 96
#define MAVLINK_MSG_ID_61_LEN 96
#define MAVLINK_MSG_ID_61_MIN_LEN 96

#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_COV_CRC 35
#define MAVLINK_MSG_ID_61_CRC 35
...
#define MAVLINK_MSG_ATTITUDE_QUATERNION_COV_FIELD_PADDING_LEN 8
#define MAVLINK_MSG_ATTITUDE_QUATERNION_COV_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION_COV { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_attitude_quaternion_cov_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 8, 72, offsetof(mavlink_attitude_quaternion_cov_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 80, offsetof(mavlink_attitude_quaternion_cov_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION_COV { \
                               ...
                               uint64_t time_usec, const float *q, float rollspeed, float pitchspeed, float yawspeed, const float *covariance)
{
    ...
    _mav_put_uint8_t_array(buf, 72, NULL, 8);
    ...
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*8);
...
/**
 * @brief Get field padding from attitude_quaternion_cov message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_attitude_quaternion_cov_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 8,  72);
}

/**
 * @brief Get field tag from attitude_quaternion_cov message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_attitude_quaternion_cov_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_attitude_quaternion_cov_decode(const mavlink_message_t* msg, mavlink_attitude_quaternion_cov_t* attitude_quaternion_cov)
{
    ...
    mavlink_msg_attitude_quaternion_cov_get_padding(msg, attitude_quaternion_cov->padding);
    mavlink_msg_attitude_quaternion_cov_get_tag(msg, attitude_quaternion_cov->tag);
#else
