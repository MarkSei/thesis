...
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM_INT { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_mission_item_int_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 38, offsetof(mavlink_mission_item_int_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM_INT { \
...
/**
 * @brief Get field padding from mission_item_int message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_item_int_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_item_int_decode(const mavlink_message_t* msg, mavlink_mission_item_int_t* mission_item_int)
{
    ...
    mavlink_msg_mission_item_int_get_padding(msg, mission_item_int->padding);
#else
