...
#define MAVLINK_MESSAGE_INFO_MISSION_CLEAR_ALL { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mission_clear_all_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 3, offsetof(mavlink_mission_clear_all_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_CLEAR_ALL { \
...
/**
 * @brief Get field padding from mission_clear_all message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_clear_all_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_clear_all_decode(const mavlink_message_t* msg, mavlink_mission_clear_all_t* mission_clear_all)
{
    ...
    mavlink_msg_mission_clear_all_get_padding(msg, mission_clear_all->padding);
#else
