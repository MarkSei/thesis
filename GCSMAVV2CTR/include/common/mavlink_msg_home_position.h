...
#define MAVLINK_MSG_ID_HOME_POSITION_LEN 64
#define MAVLINK_MSG_ID_HOME_POSITION_MIN_LEN 52
#define MAVLINK_MSG_ID_242_LEN 64
...
#define MAVLINK_MSG_HOME_POSITION_FIELD_PADDING_LEN 4
...
#define MAVLINK_MESSAGE_INFO_HOME_POSITION { \
    ...
    {  { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_home_position_t, latitude) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 60, offsetof(mavlink_home_position_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HOME_POSITION { \
...
/**
 * @brief Get field padding from home_position message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_home_position_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_home_position_decode(const mavlink_message_t* msg, mavlink_home_position_t* home_position)
{
    ...
    mavlink_msg_home_position_get_padding(msg, home_position->padding);
#else
