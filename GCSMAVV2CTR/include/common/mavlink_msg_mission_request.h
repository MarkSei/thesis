...
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mission_request_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 5, offsetof(mavlink_mission_request_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST { \
...
/**
 * @brief Get field padding from mission_request message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_request_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_request_decode(const mavlink_message_t* msg, mavlink_mission_request_t* mission_request)
{
    ...
    mavlink_msg_mission_request_get_padding(msg, mission_request->padding);
#else
