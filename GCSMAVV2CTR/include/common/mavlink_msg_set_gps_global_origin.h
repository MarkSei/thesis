...
#define MAVLINK_MESSAGE_INFO_SET_GPS_GLOBAL_ORIGIN { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_set_gps_global_origin_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 21, offsetof(mavlink_set_gps_global_origin_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_GPS_GLOBAL_ORIGIN { \
                               ...
                               uint8_t target_system, int32_t latitude, int32_t longitude, int32_t altitude, uint64_t time_usec)
{
    ...
    _mav_put_uint8_t_array(buf, 21, NULL, 11);
...
/**
 * @brief Get field padding from set_gps_global_origin message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_set_gps_global_origin_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  21);
}
...
static inline void mavlink_msg_set_gps_global_origin_decode(const mavlink_message_t* msg, mavlink_set_gps_global_origin_t* set_gps_global_origin)
{
    ...
    mavlink_msg_set_gps_global_origin_get_padding(msg, set_gps_global_origin->padding);
#else
