...
#define MAVLINK_MESSAGE_INFO_GPS_RAW_INT { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_gps_raw_int_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 50, offsetof(mavlink_gps_raw_int_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS_RAW_INT { \
                               ...
                               uint64_t time_usec, uint8_t fix_type, int32_t lat, int32_t lon, int32_t alt, uint16_t eph, uint16_t epv, uint16_t vel, uint16_t cog, uint8_t satellites_visible, int32_t alt_ellipsoid, uint32_t h_acc, uint32_t v_acc, uint32_t vel_acc, uint32_t hdg_acc)
{
    ...
    _mav_put_uint8_t_array(buf, 50, NULL, 14);
...
/**
 * @brief Get field padding from gps_raw_int message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps_raw_int_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  50);
}
...
static inline void mavlink_msg_gps_raw_int_decode(const mavlink_message_t* msg, mavlink_gps_raw_int_t* gps_raw_int)
{
    ...
    mavlink_msg_gps_raw_int_get_padding(msg, gps_raw_int->padding);
#else
