...
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_mission_item_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 38, offsetof(mavlink_mission_item_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM { \
...
/**
 * @brief Get field padding from mission_item message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_item_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_item_decode(const mavlink_message_t* msg, mavlink_mission_item_t* mission_item)
{
    ...
    mavlink_msg_mission_item_get_padding(msg, mission_item->padding);
#else
