...
#define MAVLINK_MESSAGE_INFO_GPS_GLOBAL_ORIGIN { \
    ...
    {  { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_gps_global_origin_t, latitude) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 20, offsetof(mavlink_gps_global_origin_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS_GLOBAL_ORIGIN { \
...
/**
 * @brief Get field padding from gps_global_origin message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps_global_origin_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_gps_global_origin_decode(const mavlink_message_t* msg, mavlink_gps_global_origin_t* gps_global_origin)
{
    ...
    mavlink_msg_gps_global_origin_get_padding(msg, gps_global_origin->padding);
#else
