...
#define MAVLINK_MSG_ID_PARAM_EXT_SET_LEN 160
#define MAVLINK_MSG_ID_PARAM_EXT_SET_MIN_LEN 160
#define MAVLINK_MSG_ID_323_LEN 160
#define MAVLINK_MSG_ID_323_MIN_LEN 160

#define MAVLINK_MSG_ID_PARAM_EXT_SET_CRC 92
#define MAVLINK_MSG_ID_323_CRC 92

#define MAVLINK_MSG_PARAM_EXT_SET_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_EXT_SET_FIELD_PARAM_VALUE_LEN 128
#define MAVLINK_MSG_PARAM_EXT_SET_FIELD_PADDING_LEN 13
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_SET { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_param_ext_set_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 147, offsetof(mavlink_param_ext_set_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_SET { \
                               ...
                               uint8_t target_system, uint8_t target_component, const char *param_id, const char *param_value, uint8_t param_type)
{
    ...
    _mav_put_uint8_t_array(buf, 147, NULL, 13);
...
/**
 * @brief Get field padding from param_ext_set message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_ext_set_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  147);
}
...
static inline void mavlink_msg_param_ext_set_decode(const mavlink_message_t* msg, mavlink_param_ext_set_t* param_ext_set)
{
    ...
    mavlink_msg_param_ext_set_get_padding(msg, param_ext_set->padding);
#else
