...
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_LIST { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mission_request_list_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 3, offsetof(mavlink_mission_request_list_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_LIST { \
...
/**
 * @brief Get field padding from mission_request_list message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_request_list_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_request_list_decode(const mavlink_message_t* msg, mavlink_mission_request_list_t* mission_request_list)
{
    ...
    mavlink_msg_mission_request_list_get_padding(msg, mission_request_list->padding);
#else
