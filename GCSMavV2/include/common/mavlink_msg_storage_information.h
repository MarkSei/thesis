...
#define MAVLINK_MSG_ID_STORAGE_INFORMATION_LEN 32
#define MAVLINK_MSG_ID_STORAGE_INFORMATION_MIN_LEN 32
#define MAVLINK_MSG_ID_261_LEN 32
#define MAVLINK_MSG_ID_261_MIN_LEN 32

#define MAVLINK_MSG_ID_STORAGE_INFORMATION_CRC 243
#define MAVLINK_MSG_ID_261_CRC 243

#define MAVLINK_MSG_STORAGE_INFORMATION_FIELD_PADDING_LEN 5
...
#define MAVLINK_MESSAGE_INFO_STORAGE_INFORMATION { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_storage_information_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 5, 27, offsetof(mavlink_storage_information_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_STORAGE_INFORMATION { \
...
/**
 * @brief Get field padding from storage_information message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_storage_information_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_storage_information_decode(const mavlink_message_t* msg, mavlink_storage_information_t* storage_information)
{
    ...
    mavlink_msg_storage_information_get_padding(msg, storage_information->padding);
#else
