...
#define MAVLINK_MSG_ID_FLIGHT_INFORMATION_MIN_LEN 32
#define MAVLINK_MSG_ID_264_LEN 32
#define MAVLINK_MSG_ID_264_MIN_LEN 32

#define MAVLINK_MSG_ID_FLIGHT_INFORMATION_CRC 194
#define MAVLINK_MSG_ID_264_CRC 194

#define MAVLINK_MSG_FLIGHT_INFORMATION_FIELD_PADDING_LEN 4
...
#define MAVLINK_MESSAGE_INFO_FLIGHT_INFORMATION { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 24, offsetof(mavlink_flight_information_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 28, offsetof(mavlink_flight_information_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_FLIGHT_INFORMATION { \
...
/**
 * @brief Get field padding from flight_information message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_flight_information_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_flight_information_decode(const mavlink_message_t* msg, mavlink_flight_information_t* flight_information)
{
    ...
    mavlink_msg_flight_information_get_padding(msg, flight_information->padding);
#else
