...
#define MAVLINK_MESSAGE_INFO_MISSION_WRITE_PARTIAL_LIST { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mission_write_partial_list_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 9, 7, offsetof(mavlink_mission_write_partial_list_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_WRITE_PARTIAL_LIST { \
                               ...
                               uint8_t target_system, uint8_t target_component, int16_t start_index, int16_t end_index, uint8_t mission_type)
{
    ...
    _mav_put_uint8_t_array(buf, 7, NULL, 9);
...
/**
 * @brief Get field padding from mission_write_partial_list message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_write_partial_list_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 9,  7);
}
...
static inline void mavlink_msg_mission_write_partial_list_decode(const mavlink_message_t* msg, mavlink_mission_write_partial_list_t* mission_write_partial_list)
{
    ...
    mavlink_msg_mission_write_partial_list_get_padding(msg, mission_write_partial_list->padding);
#else
