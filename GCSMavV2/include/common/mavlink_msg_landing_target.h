...
#define MAVLINK_MSG_ID_LANDING_TARGET_LEN 64
#define MAVLINK_MSG_ID_LANDING_TARGET_MIN_LEN 30
#define MAVLINK_MSG_ID_149_LEN 64
...
#define MAVLINK_MSG_LANDING_TARGET_FIELD_PADDING_LEN 4
...
#define MAVLINK_MESSAGE_INFO_LANDING_TARGET { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_landing_target_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 60, offsetof(mavlink_landing_target_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LANDING_TARGET { \
                               ...
                               uint64_t time_usec, uint8_t target_num, uint8_t frame, float angle_x, float angle_y, float distance, float size_x, float size_y, float x, float y, float z, const float *q, uint8_t type, uint8_t position_valid)
{
    ...
    _mav_put_uint8_t_array(buf, 60, NULL, 4);
...
/**
 * @brief Get field padding from landing_target message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_landing_target_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  60);
}
...
static inline void mavlink_msg_landing_target_decode(const mavlink_message_t* msg, mavlink_landing_target_t* landing_target)
{
    ...
    mavlink_msg_landing_target_get_padding(msg, landing_target->padding);
#else
