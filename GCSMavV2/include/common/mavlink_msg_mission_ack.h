...
#define MAVLINK_MESSAGE_INFO_MISSION_ACK { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mission_ack_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 4, offsetof(mavlink_mission_ack_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_ACK { \
...
/**
 * @brief Get field padding from mission_ack message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_ack_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_ack_decode(const mavlink_message_t* msg, mavlink_mission_ack_t* mission_ack)
{
    ...
    mavlink_msg_mission_ack_get_padding(msg, mission_ack->padding);
#else
