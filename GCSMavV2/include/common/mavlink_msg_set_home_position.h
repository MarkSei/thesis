...
#define MAVLINK_MSG_ID_SET_HOME_POSITION_LEN 64
#define MAVLINK_MSG_ID_SET_HOME_POSITION_MIN_LEN 53
#define MAVLINK_MSG_ID_243_LEN 64
...
#define MAVLINK_MSG_SET_HOME_POSITION_FIELD_PADDING_LEN 3
...
#define MAVLINK_MESSAGE_INFO_SET_HOME_POSITION { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 52, offsetof(mavlink_set_home_position_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 3, 61, offsetof(mavlink_set_home_position_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_HOME_POSITION { \
                               ...
                               uint8_t target_system, int32_t latitude, int32_t longitude, int32_t altitude, float x, float y, float z, const float *q, float approach_x, float approach_y, float approach_z, uint64_t time_usec)
{
    ...
    _mav_put_uint8_t_array(buf, 61, NULL, 3);
...
/**
 * @brief Get field padding from set_home_position message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_set_home_position_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 3,  61);
}
...
static inline void mavlink_msg_set_home_position_decode(const mavlink_message_t* msg, mavlink_set_home_position_t* set_home_position)
{
    ...
    mavlink_msg_set_home_position_get_padding(msg, set_home_position->padding);
#else
