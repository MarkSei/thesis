...
#define MAVLINK_MSG_ID_BUTTON_CHANGE_LEN 16
#define MAVLINK_MSG_ID_BUTTON_CHANGE_MIN_LEN 16
#define MAVLINK_MSG_ID_257_LEN 16
#define MAVLINK_MSG_ID_257_MIN_LEN 16

#define MAVLINK_MSG_ID_BUTTON_CHANGE_CRC 229
#define MAVLINK_MSG_ID_257_CRC 229

#define MAVLINK_MSG_BUTTON_CHANGE_FIELD_PADDING_LEN 7
...
#define MAVLINK_MESSAGE_INFO_BUTTON_CHANGE { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_button_change_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 9, offsetof(mavlink_button_change_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_BUTTON_CHANGE { \
...
/**
 * @brief Get field padding from button_change message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_button_change_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_button_change_decode(const mavlink_message_t* msg, mavlink_button_change_t* button_change)
{
    ...
    mavlink_msg_button_change_get_padding(msg, button_change->padding);
#else
