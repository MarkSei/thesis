...
#define MAVLINK_MESSAGE_INFO_SERVO_OUTPUT_RAW { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_servo_output_raw_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 37, offsetof(mavlink_servo_output_raw_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SERVO_OUTPUT_RAW { \
...
/**
 * @brief Get field padding from servo_output_raw message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_servo_output_raw_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_servo_output_raw_decode(const mavlink_message_t* msg, mavlink_servo_output_raw_t* servo_output_raw)
{
    ...
    mavlink_msg_servo_output_raw_get_padding(msg, servo_output_raw->padding);
#else
