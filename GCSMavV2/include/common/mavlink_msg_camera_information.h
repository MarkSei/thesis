...
#define MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN 240
#define MAVLINK_MSG_ID_CAMERA_INFORMATION_MIN_LEN 240
#define MAVLINK_MSG_ID_259_LEN 240
#define MAVLINK_MSG_ID_259_MIN_LEN 240

#define MAVLINK_MSG_ID_CAMERA_INFORMATION_CRC 254
#define MAVLINK_MSG_ID_259_CRC 254
...
#define MAVLINK_MSG_CAMERA_INFORMATION_FIELD_PADDING_LEN 5
...
#define MAVLINK_MESSAGE_INFO_CAMERA_INFORMATION { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_camera_information_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 5, 235, offsetof(mavlink_camera_information_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_INFORMATION { \
                               ...
                               uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, float focal_length, float sensor_size_h, float sensor_size_v, uint16_t resolution_h, uint16_t resolution_v, uint8_t lens_id, uint32_t flags, uint16_t cam_definition_version, const char *cam_definition_uri)
{
    ...
    _mav_put_uint8_t_array(buf, 235, NULL, 5);
...
/**
 * @brief Get field padding from camera_information message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_camera_information_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 5,  235);
}
...
static inline void mavlink_msg_camera_information_decode(const mavlink_message_t* msg, mavlink_camera_information_t* camera_information)
{
    ...
    mavlink_msg_camera_information_get_padding(msg, camera_information->padding);
#else
