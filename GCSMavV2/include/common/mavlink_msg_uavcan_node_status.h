...
#define MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_LEN 32
#define MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_MIN_LEN 32
#define MAVLINK_MSG_ID_310_LEN 32
#define MAVLINK_MSG_ID_310_MIN_LEN 32

#define MAVLINK_MSG_ID_UAVCAN_NODE_STATUS_CRC 153
#define MAVLINK_MSG_ID_310_CRC 153

#define MAVLINK_MSG_UAVCAN_NODE_STATUS_FIELD_PADDING_LEN 15
...
#define MAVLINK_MESSAGE_INFO_UAVCAN_NODE_STATUS { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_uavcan_node_status_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 15, 17, offsetof(mavlink_uavcan_node_status_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_UAVCAN_NODE_STATUS { \
                               ...
                               uint64_t time_usec, uint32_t uptime_sec, uint8_t health, uint8_t mode, uint8_t sub_mode, uint16_t vendor_specific_status_code)
{
    ...
    _mav_put_uint8_t_array(buf, 17, NULL, 15);
...
/**
 * @brief Get field padding from uavcan_node_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_uavcan_node_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 15,  17);
}
...
static inline void mavlink_msg_uavcan_node_status_decode(const mavlink_message_t* msg, mavlink_uavcan_node_status_t* uavcan_node_status)
{
    ...
    mavlink_msg_uavcan_node_status_get_padding(msg, uavcan_node_status->padding);
#else
