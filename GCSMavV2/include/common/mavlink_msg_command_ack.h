...
#define MAVLINK_MESSAGE_INFO_COMMAND_ACK { \
    ...
    {  { "command", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_command_ack_t, command) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 6, 10, offsetof(mavlink_command_ack_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_COMMAND_ACK { \
                               ...
                               uint16_t command, uint8_t result, uint8_t progress, int32_t result_param2, uint8_t target_system, uint8_t target_component)
{
    ...
    _mav_put_uint8_t_array(buf, 10, NULL, 6);
...
/**
 * @brief Get field padding from command_ack message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_command_ack_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 6,  10);
}
...
static inline void mavlink_msg_command_ack_decode(const mavlink_message_t* msg, mavlink_command_ack_t* command_ack)
{
    ...
    mavlink_msg_command_ack_get_padding(msg, command_ack->padding);
#else
