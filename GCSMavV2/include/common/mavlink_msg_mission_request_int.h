...
#define MAVLINK_MSG_ID_MISSION_REQUEST_INT_LEN 16
...
#define MAVLINK_MSG_MISSION_REQUEST_INT_FIELD_PADDING_LEN 11
...
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_INT { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mission_request_int_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 5, offsetof(mavlink_mission_request_int_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_REQUEST_INT { \
...
/**
 * @brief Get field padding from mission_request_int message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_request_int_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_request_int_decode(const mavlink_message_t* msg, mavlink_mission_request_int_t* mission_request_int)
{
    ...
    mavlink_msg_mission_request_int_get_padding(msg, mission_request_int->padding);
#else
