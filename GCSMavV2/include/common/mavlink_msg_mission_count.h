...
#define MAVLINK_MESSAGE_INFO_MISSION_COUNT { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mission_count_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 5, offsetof(mavlink_mission_count_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_COUNT { \
...
/**
 * @brief Get field padding from mission_count message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_count_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mission_count_decode(const mavlink_message_t* msg, mavlink_mission_count_t* mission_count)
{
    ...
    mavlink_msg_mission_count_get_padding(msg, mission_count->padding);
#else
