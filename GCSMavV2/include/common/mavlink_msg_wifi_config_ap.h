...
#define MAVLINK_MSG_ID_WIFI_CONFIG_AP_LEN 112
#define MAVLINK_MSG_ID_WIFI_CONFIG_AP_MIN_LEN 112
#define MAVLINK_MSG_ID_299_LEN 112
#define MAVLINK_MSG_ID_299_MIN_LEN 112

#define MAVLINK_MSG_ID_WIFI_CONFIG_AP_CRC 56
#define MAVLINK_MSG_ID_299_CRC 56

#define MAVLINK_MSG_WIFI_CONFIG_AP_FIELD_SSID_LEN 32
#define MAVLINK_MSG_WIFI_CONFIG_AP_FIELD_PASSWORD_LEN 64
#define MAVLINK_MSG_WIFI_CONFIG_AP_FIELD_PADDING_LEN 16
...
#define MAVLINK_MESSAGE_INFO_WIFI_CONFIG_AP { \
    ...
    {  { "ssid", NULL, MAVLINK_TYPE_CHAR, 32, 0, offsetof(mavlink_wifi_config_ap_t, ssid) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 96, offsetof(mavlink_wifi_config_ap_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_WIFI_CONFIG_AP { \
...
/**
 * @brief Get field padding from wifi_config_ap message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_wifi_config_ap_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  96);
}
...
static inline void mavlink_msg_wifi_config_ap_decode(const mavlink_message_t* msg, mavlink_wifi_config_ap_t* wifi_config_ap)
{
    ...
    mavlink_msg_wifi_config_ap_get_padding(msg, wifi_config_ap->padding);
#else
