...
#define MAVLINK_MSG_ID_DEBUG_LEN 32
#define MAVLINK_MSG_ID_DEBUG_MIN_LEN 32
#define MAVLINK_MSG_ID_254_LEN 32
#define MAVLINK_MSG_ID_254_MIN_LEN 32

#define MAVLINK_MSG_ID_DEBUG_CRC 53
#define MAVLINK_MSG_ID_254_CRC 53

#define MAVLINK_MSG_DEBUG_FIELD_PADDING_LEN 7
#define MAVLINK_MSG_DEBUG_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_DEBUG { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_debug_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 9, offsetof(mavlink_debug_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_debug_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_DEBUG { \
...
/**
 * @brief Get field padding from debug message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_debug_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 7,  9);
}

/**
 * @brief Get field tag from debug message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_debug_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_debug_decode(const mavlink_message_t* msg, mavlink_debug_t* debug)
{
    ...
    mavlink_msg_debug_get_padding(msg, debug->padding);
    mavlink_msg_debug_get_tag(msg, debug->tag);
#else
