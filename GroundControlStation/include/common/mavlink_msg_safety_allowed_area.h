...
#define MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_LEN 48
#define MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_MIN_LEN 48
#define MAVLINK_MSG_ID_55_LEN 48
#define MAVLINK_MSG_ID_55_MIN_LEN 48

#define MAVLINK_MSG_ID_SAFETY_ALLOWED_AREA_CRC 147
#define MAVLINK_MSG_ID_55_CRC 147

#define MAVLINK_MSG_SAFETY_ALLOWED_AREA_FIELD_PADDING_LEN 7
#define MAVLINK_MSG_SAFETY_ALLOWED_AREA_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SAFETY_ALLOWED_AREA { \
    ...
    {  { "frame", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_safety_allowed_area_t, frame) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 25, offsetof(mavlink_safety_allowed_area_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_safety_allowed_area_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SAFETY_ALLOWED_AREA { \
                               ...
                               uint8_t frame, float p1x, float p1y, float p1z, float p2x, float p2y, float p2z)
{
    ...
    _mav_put_uint8_t_array(buf, 25, NULL, 7);
...
/**
 * @brief Get field padding from safety_allowed_area message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_safety_allowed_area_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 7,  25);
}

/**
 * @brief Get field tag from safety_allowed_area message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_safety_allowed_area_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_safety_allowed_area_decode(const mavlink_message_t* msg, mavlink_safety_allowed_area_t* safety_allowed_area)
{
    ...
    mavlink_msg_safety_allowed_area_get_padding(msg, safety_allowed_area->padding);
    mavlink_msg_safety_allowed_area_get_tag(msg, safety_allowed_area->tag);
#else
