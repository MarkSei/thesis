...
#define MAVLINK_MSG_ID_FOLLOW_TARGET_LEN 112
#define MAVLINK_MSG_ID_FOLLOW_TARGET_MIN_LEN 112
#define MAVLINK_MSG_ID_144_LEN 112
#define MAVLINK_MSG_ID_144_MIN_LEN 112

#define MAVLINK_MSG_ID_FOLLOW_TARGET_CRC 57
#define MAVLINK_MSG_ID_144_CRC 57
...
#define MAVLINK_MSG_FOLLOW_TARGET_FIELD_PADDING_LEN 3
#define MAVLINK_MSG_FOLLOW_TARGET_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_FOLLOW_TARGET { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_follow_target_t, timestamp) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 3, 93, offsetof(mavlink_follow_target_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 96, offsetof(mavlink_follow_target_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_FOLLOW_TARGET { \
                               ...
                               uint64_t timestamp, uint8_t est_capabilities, int32_t lat, int32_t lon, float alt, const float *vel, const float *acc, const float *attitude_q, const float *rates, const float *position_cov, uint64_t custom_state)
{
    ...
    _mav_put_uint8_t_array(buf, 93, NULL, 3);
...
/**
 * @brief Get field padding from follow_target message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_follow_target_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 3,  93);
}

/**
 * @brief Get field tag from follow_target message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_follow_target_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_follow_target_decode(const mavlink_message_t* msg, mavlink_follow_target_t* follow_target)
{
    ...
    mavlink_msg_follow_target_get_padding(msg, follow_target->padding);
    mavlink_msg_follow_target_get_tag(msg, follow_target->tag);
#else
