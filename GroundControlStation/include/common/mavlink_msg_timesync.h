...
#define MAVLINK_MSG_ID_TIMESYNC_LEN 48
#define MAVLINK_MSG_ID_TIMESYNC_MIN_LEN 48
#define MAVLINK_MSG_ID_111_LEN 48
#define MAVLINK_MSG_ID_111_MIN_LEN 48

#define MAVLINK_MSG_ID_TIMESYNC_CRC 172
#define MAVLINK_MSG_ID_111_CRC 172

#define MAVLINK_MSG_TIMESYNC_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_TIMESYNC_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_TIMESYNC { \
    ...
    {  { "tc1", NULL, MAVLINK_TYPE_INT64_T, 0, 0, offsetof(mavlink_timesync_t, tc1) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_timesync_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_timesync_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TIMESYNC { \
...
/**
 * @brief Get field padding from timesync message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_timesync_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  16);
}

/**
 * @brief Get field tag from timesync message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_timesync_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_timesync_decode(const mavlink_message_t* msg, mavlink_timesync_t* timesync)
{
    ...
    mavlink_msg_timesync_get_padding(msg, timesync->padding);
    mavlink_msg_timesync_get_tag(msg, timesync->tag);
#else
