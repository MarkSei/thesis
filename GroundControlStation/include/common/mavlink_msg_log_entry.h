...
#define MAVLINK_MSG_ID_LOG_ENTRY_LEN 32
#define MAVLINK_MSG_ID_LOG_ENTRY_MIN_LEN 32
#define MAVLINK_MSG_ID_118_LEN 32
#define MAVLINK_MSG_ID_118_MIN_LEN 32

#define MAVLINK_MSG_ID_LOG_ENTRY_CRC 87
#define MAVLINK_MSG_ID_118_CRC 87

#define MAVLINK_MSG_LOG_ENTRY_FIELD_PADDING_LEN 2
#define MAVLINK_MSG_LOG_ENTRY_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_LOG_ENTRY { \
    ...
    {  { "id", NULL, MAVLINK_TYPE_UINT16_T, 0, 8, offsetof(mavlink_log_entry_t, id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 2, 14, offsetof(mavlink_log_entry_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_log_entry_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOG_ENTRY { \
...
/**
 * @brief Get field padding from log_entry message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_log_entry_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 2,  14);
}

/**
 * @brief Get field tag from log_entry message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_log_entry_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_log_entry_decode(const mavlink_message_t* msg, mavlink_log_entry_t* log_entry)
{
    ...
    mavlink_msg_log_entry_get_padding(msg, log_entry->padding);
    mavlink_msg_log_entry_get_tag(msg, log_entry->tag);
#else
