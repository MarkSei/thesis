...
#define MAVLINK_MSG_ID_MOUNT_ORIENTATION_LEN 32
#define MAVLINK_MSG_ID_MOUNT_ORIENTATION_MIN_LEN 32
#define MAVLINK_MSG_ID_265_LEN 32
#define MAVLINK_MSG_ID_265_MIN_LEN 32

#define MAVLINK_MSG_ID_MOUNT_ORIENTATION_CRC 115
#define MAVLINK_MSG_ID_265_CRC 115

#define MAVLINK_MSG_MOUNT_ORIENTATION_FIELD_PADDING_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MOUNT_ORIENTATION { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_mount_orientation_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_mount_orientation_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MOUNT_ORIENTATION { \
...
/**
 * @brief Get field padding from mount_orientation message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mount_orientation_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_mount_orientation_decode(const mavlink_message_t* msg, mavlink_mount_orientation_t* mount_orientation)
{
    ...
    mavlink_msg_mount_orientation_get_padding(msg, mount_orientation->padding);
#else
