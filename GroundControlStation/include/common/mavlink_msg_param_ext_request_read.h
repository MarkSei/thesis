...
#define MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN 32
#define MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_MIN_LEN 32
#define MAVLINK_MSG_ID_320_LEN 32
#define MAVLINK_MSG_ID_320_MIN_LEN 32

#define MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_CRC 62
#define MAVLINK_MSG_ID_320_CRC 62

#define MAVLINK_MSG_PARAM_EXT_REQUEST_READ_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_EXT_REQUEST_READ_FIELD_PADDING_LEN 12
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_REQUEST_READ { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_param_ext_request_read_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 20, offsetof(mavlink_param_ext_request_read_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_REQUEST_READ { \
...
/**
 * @brief Get field padding from param_ext_request_read message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_ext_request_read_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_param_ext_request_read_decode(const mavlink_message_t* msg, mavlink_param_ext_request_read_t* param_ext_request_read)
{
    ...
    mavlink_msg_param_ext_request_read_get_padding(msg, param_ext_request_read->padding);
#else
