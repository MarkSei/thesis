...
#define MAVLINK_MSG_ID_PLAY_TUNE_LEN 48
#define MAVLINK_MSG_ID_PLAY_TUNE_MIN_LEN 48
#define MAVLINK_MSG_ID_258_LEN 48
#define MAVLINK_MSG_ID_258_MIN_LEN 48

#define MAVLINK_MSG_ID_PLAY_TUNE_CRC 135
#define MAVLINK_MSG_ID_258_CRC 135

#define MAVLINK_MSG_PLAY_TUNE_FIELD_TUNE_LEN 30
#define MAVLINK_MSG_PLAY_TUNE_FIELD_PADDING_LEN 16
...
#define MAVLINK_MESSAGE_INFO_PLAY_TUNE { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_play_tune_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_play_tune_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PLAY_TUNE { \
...
/**
 * @brief Get field padding from play_tune message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_play_tune_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_play_tune_decode(const mavlink_message_t* msg, mavlink_play_tune_t* play_tune)
{
    ...
    mavlink_msg_play_tune_get_padding(msg, play_tune->padding);
#else
