...
#define MAVLINK_MSG_ID_COLLISION_LEN 48
#define MAVLINK_MSG_ID_COLLISION_MIN_LEN 48
#define MAVLINK_MSG_ID_247_LEN 48
#define MAVLINK_MSG_ID_247_MIN_LEN 48

#define MAVLINK_MSG_ID_COLLISION_CRC 47
#define MAVLINK_MSG_ID_247_CRC 47

#define MAVLINK_MSG_COLLISION_FIELD_PADDING_LEN 13
#define MAVLINK_MSG_COLLISION_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_COLLISION { \
    ...
    {  { "src", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_collision_t, src) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 19, offsetof(mavlink_collision_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_collision_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_COLLISION { \
                               ...
                               uint8_t src, uint32_t id, uint8_t action, uint8_t threat_level, float time_to_minimum_delta, float altitude_minimum_delta, float horizontal_minimum_delta)
{
    ...
    _mav_put_uint8_t_array(buf, 19, NULL, 13);
...
/**
 * @brief Get field padding from collision message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_collision_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  19);
}

/**
 * @brief Get field tag from collision message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_collision_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_collision_decode(const mavlink_message_t* msg, mavlink_collision_t* collision)
{
    ...
    mavlink_msg_collision_get_padding(msg, collision->padding);
    mavlink_msg_collision_get_tag(msg, collision->tag);
#else
