...
#define MAVLINK_MSG_ID_LOGGING_ACK_LEN 16
#define MAVLINK_MSG_ID_LOGGING_ACK_MIN_LEN 16
#define MAVLINK_MSG_ID_268_LEN 16
#define MAVLINK_MSG_ID_268_MIN_LEN 16

#define MAVLINK_MSG_ID_LOGGING_ACK_CRC 17
#define MAVLINK_MSG_ID_268_CRC 17

#define MAVLINK_MSG_LOGGING_ACK_FIELD_PADDING_LEN 12
...
#define MAVLINK_MESSAGE_INFO_LOGGING_ACK { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_logging_ack_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 4, offsetof(mavlink_logging_ack_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOGGING_ACK { \
...
/**
 * @brief Get field padding from logging_ack message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_logging_ack_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_logging_ack_decode(const mavlink_message_t* msg, mavlink_logging_ack_t* logging_ack)
{
    ...
    mavlink_msg_logging_ack_get_padding(msg, logging_ack->padding);
#else
