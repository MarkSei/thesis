...
#define MAVLINK_MSG_ID_RADIO_STATUS_LEN 32
#define MAVLINK_MSG_ID_RADIO_STATUS_MIN_LEN 32
#define MAVLINK_MSG_ID_109_LEN 32
#define MAVLINK_MSG_ID_109_MIN_LEN 32

#define MAVLINK_MSG_ID_RADIO_STATUS_CRC 151
#define MAVLINK_MSG_ID_109_CRC 151

#define MAVLINK_MSG_RADIO_STATUS_FIELD_PADDING_LEN 7
#define MAVLINK_MSG_RADIO_STATUS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_RADIO_STATUS { \
    ...
    {  { "rssi", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_radio_status_t, rssi) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 9, offsetof(mavlink_radio_status_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_radio_status_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RADIO_STATUS { \
                               ...
                               uint8_t rssi, uint8_t remrssi, uint8_t txbuf, uint8_t noise, uint8_t remnoise, uint16_t rxerrors, uint16_t fixed)
{
    ...
    _mav_put_uint8_t_array(buf, 9, NULL, 7);
...
/**
 * @brief Get field padding from radio_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_radio_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 7,  9);
}

/**
 * @brief Get field tag from radio_status message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_radio_status_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_radio_status_decode(const mavlink_message_t* msg, mavlink_radio_status_t* radio_status)
{
    ...
    mavlink_msg_radio_status_get_padding(msg, radio_status->padding);
    mavlink_msg_radio_status_get_tag(msg, radio_status->tag);
#else
