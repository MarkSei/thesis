...
#define MAVLINK_MSG_ID_PARAM_VALUE_LEN 48
#define MAVLINK_MSG_ID_PARAM_VALUE_MIN_LEN 48
#define MAVLINK_MSG_ID_22_LEN 48
#define MAVLINK_MSG_ID_22_MIN_LEN 48
...
#define MAVLINK_MSG_PARAM_VALUE_FIELD_PADDING_LEN 7
#define MAVLINK_MSG_PARAM_VALUE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_PARAM_VALUE { \
    ...
    {  { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 8, offsetof(mavlink_param_value_t, param_id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 25, offsetof(mavlink_param_value_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_param_value_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_VALUE { \
...
/**
 * @brief Get field padding from param_value message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_value_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 7,  25);
}

/**
 * @brief Get field tag from param_value message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_param_value_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_param_value_decode(const mavlink_message_t* msg, mavlink_param_value_t* param_value)
{
    ...
    mavlink_msg_param_value_get_padding(msg, param_value->padding);
    mavlink_msg_param_value_get_tag(msg, param_value->tag);
#else
