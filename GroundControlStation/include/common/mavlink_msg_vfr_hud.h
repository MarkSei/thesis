...
#define MAVLINK_MSG_ID_VFR_HUD_LEN 48
#define MAVLINK_MSG_ID_VFR_HUD_MIN_LEN 48
#define MAVLINK_MSG_ID_74_LEN 48
#define MAVLINK_MSG_ID_74_MIN_LEN 48

#define MAVLINK_MSG_ID_VFR_HUD_CRC 100
#define MAVLINK_MSG_ID_74_CRC 100

#define MAVLINK_MSG_VFR_HUD_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_VFR_HUD_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_VFR_HUD { \
    ...
    {  { "airspeed", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_vfr_hud_t, airspeed) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 20, offsetof(mavlink_vfr_hud_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_vfr_hud_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_VFR_HUD { \
...
/**
 * @brief Get field padding from vfr_hud message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_vfr_hud_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  20);
}

/**
 * @brief Get field tag from vfr_hud message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_vfr_hud_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_vfr_hud_decode(const mavlink_message_t* msg, mavlink_vfr_hud_t* vfr_hud)
{
    ...
    mavlink_msg_vfr_hud_get_padding(msg, vfr_hud->padding);
    mavlink_msg_vfr_hud_get_tag(msg, vfr_hud->tag);
#else
