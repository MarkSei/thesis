...
#define MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN 32
#define MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN 32
#define MAVLINK_MSG_ID_244_LEN 32
#define MAVLINK_MSG_ID_244_MIN_LEN 32

#define MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC 8
#define MAVLINK_MSG_ID_244_CRC 8

#define MAVLINK_MSG_MESSAGE_INTERVAL_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_MESSAGE_INTERVAL_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MESSAGE_INTERVAL { \
    ...
    {  { "message_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_message_interval_t, message_id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 6, offsetof(mavlink_message_interval_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_message_interval_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MESSAGE_INTERVAL { \
...
/**
 * @brief Get field padding from message_interval message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_message_interval_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  6);
}

/**
 * @brief Get field tag from message_interval message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_message_interval_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_message_interval_decode(const mavlink_message_t* msg, mavlink_message_interval_t* message_interval)
{
    ...
    mavlink_msg_message_interval_get_padding(msg, message_interval->padding);
    mavlink_msg_message_interval_get_tag(msg, message_interval->tag);
#else
