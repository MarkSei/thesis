...
#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN 64
#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_MIN_LEN 64
#define MAVLINK_MSG_ID_31_LEN 64
#define MAVLINK_MSG_ID_31_MIN_LEN 64

#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_CRC 250
#define MAVLINK_MSG_ID_31_CRC 250

#define MAVLINK_MSG_ATTITUDE_QUATERNION_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_ATTITUDE_QUATERNION_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_attitude_quaternion_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_attitude_quaternion_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_attitude_quaternion_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ATTITUDE_QUATERNION { \
...
/**
 * @brief Get field padding from attitude_quaternion message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_attitude_quaternion_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  32);
}

/**
 * @brief Get field tag from attitude_quaternion message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_attitude_quaternion_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_attitude_quaternion_decode(const mavlink_message_t* msg, mavlink_attitude_quaternion_t* attitude_quaternion)
{
    ...
    mavlink_msg_attitude_quaternion_get_padding(msg, attitude_quaternion->padding);
    mavlink_msg_attitude_quaternion_get_tag(msg, attitude_quaternion->tag);
#else
