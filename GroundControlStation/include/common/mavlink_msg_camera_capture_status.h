...
#define MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN 32
#define MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_MIN_LEN 32
#define MAVLINK_MSG_ID_262_LEN 32
#define MAVLINK_MSG_ID_262_MIN_LEN 32

#define MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_CRC 154
#define MAVLINK_MSG_ID_262_CRC 154

#define MAVLINK_MSG_CAMERA_CAPTURE_STATUS_FIELD_PADDING_LEN 14
...
#define MAVLINK_MESSAGE_INFO_CAMERA_CAPTURE_STATUS { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_camera_capture_status_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 18, offsetof(mavlink_camera_capture_status_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_CAPTURE_STATUS { \
...
/**
 * @brief Get field padding from camera_capture_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_camera_capture_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
...
static inline void mavlink_msg_camera_capture_status_decode(const mavlink_message_t* msg, mavlink_camera_capture_status_t* camera_capture_status)
{
    ...
    mavlink_msg_camera_capture_status_get_padding(msg, camera_capture_status->padding);
#else
