...
#define MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN 16
#define MAVLINK_MSG_ID_CAMERA_SETTINGS_MIN_LEN 16
#define MAVLINK_MSG_ID_260_LEN 16
#define MAVLINK_MSG_ID_260_MIN_LEN 16

#define MAVLINK_MSG_ID_CAMERA_SETTINGS_CRC 254
#define MAVLINK_MSG_ID_260_CRC 254

#define MAVLINK_MSG_CAMERA_SETTINGS_FIELD_PADDING_LEN 11
...
#define MAVLINK_MESSAGE_INFO_CAMERA_SETTINGS { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_camera_settings_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 5, offsetof(mavlink_camera_settings_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_SETTINGS { \
                               ...
                               uint32_t time_boot_ms, uint8_t mode_id)
{
    ...
    _mav_put_uint8_t_array(buf, 5, NULL, 11);
...
/**
 * @brief Get field padding from camera_settings message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_camera_settings_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  5);
}
...
static inline void mavlink_msg_camera_settings_decode(const mavlink_message_t* msg, mavlink_camera_settings_t* camera_settings)
{
    ...
    mavlink_msg_camera_settings_get_padding(msg, camera_settings->padding);
#else
