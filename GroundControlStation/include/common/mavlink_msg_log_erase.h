...
#define MAVLINK_MSG_ID_LOG_ERASE_LEN 32
#define MAVLINK_MSG_ID_LOG_ERASE_MIN_LEN 32
#define MAVLINK_MSG_ID_121_LEN 32
#define MAVLINK_MSG_ID_121_MIN_LEN 32

#define MAVLINK_MSG_ID_LOG_ERASE_CRC 250
#define MAVLINK_MSG_ID_121_CRC 250

#define MAVLINK_MSG_LOG_ERASE_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_LOG_ERASE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_LOG_ERASE { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_log_erase_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 2, offsetof(mavlink_log_erase_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_log_erase_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOG_ERASE { \
...
/**
 * @brief Get field padding from log_erase message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_log_erase_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  2);
}

/**
 * @brief Get field tag from log_erase message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_log_erase_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_log_erase_decode(const mavlink_message_t* msg, mavlink_log_erase_t* log_erase)
{
    ...
    mavlink_msg_log_erase_get_padding(msg, log_erase->padding);
    mavlink_msg_log_erase_get_tag(msg, log_erase->tag);
#else
