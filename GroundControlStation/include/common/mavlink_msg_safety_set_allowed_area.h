...
#define MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_LEN 48
#define MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_MIN_LEN 48
#define MAVLINK_MSG_ID_54_LEN 48
#define MAVLINK_MSG_ID_54_MIN_LEN 48

#define MAVLINK_MSG_ID_SAFETY_SET_ALLOWED_AREA_CRC 158
#define MAVLINK_MSG_ID_54_CRC 158

#define MAVLINK_MSG_SAFETY_SET_ALLOWED_AREA_FIELD_PADDING_LEN 5
#define MAVLINK_MSG_SAFETY_SET_ALLOWED_AREA_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SAFETY_SET_ALLOWED_AREA { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_safety_set_allowed_area_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 5, 27, offsetof(mavlink_safety_set_allowed_area_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_safety_set_allowed_area_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SAFETY_SET_ALLOWED_AREA { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t frame, float p1x, float p1y, float p1z, float p2x, float p2y, float p2z)
{
    ...
    _mav_put_uint8_t_array(buf, 27, NULL, 5);
...
/**
 * @brief Get field padding from safety_set_allowed_area message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_safety_set_allowed_area_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 5,  27);
}

/**
 * @brief Get field tag from safety_set_allowed_area message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_safety_set_allowed_area_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_safety_set_allowed_area_decode(const mavlink_message_t* msg, mavlink_safety_set_allowed_area_t* safety_set_allowed_area)
{
    ...
    mavlink_msg_safety_set_allowed_area_get_padding(msg, safety_set_allowed_area->padding);
    mavlink_msg_safety_set_allowed_area_get_tag(msg, safety_set_allowed_area->tag);
#else
