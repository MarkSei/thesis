...
#define MAVLINK_MSG_ID_COMMAND_INT_LEN 64
#define MAVLINK_MSG_ID_COMMAND_INT_MIN_LEN 64
#define MAVLINK_MSG_ID_75_LEN 64
#define MAVLINK_MSG_ID_75_MIN_LEN 64

#define MAVLINK_MSG_ID_COMMAND_INT_CRC 227
#define MAVLINK_MSG_ID_75_CRC 227

#define MAVLINK_MSG_COMMAND_INT_FIELD_PADDING_LEN 13
#define MAVLINK_MSG_COMMAND_INT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_COMMAND_INT { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 30, offsetof(mavlink_command_int_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 35, offsetof(mavlink_command_int_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_command_int_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_COMMAND_INT { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t frame, uint16_t command, uint8_t current, uint8_t autocontinue, float param1, float param2, float param3, float param4, int32_t x, int32_t y, float z)
{
    ...
    _mav_put_uint8_t_array(buf, 35, NULL, 13);
...
/**
 * @brief Get field padding from command_int message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_command_int_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  35);
}

/**
 * @brief Get field tag from command_int message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_command_int_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_command_int_decode(const mavlink_message_t* msg, mavlink_command_int_t* command_int)
{
    ...
    mavlink_msg_command_int_get_padding(msg, command_int->padding);
    mavlink_msg_command_int_get_tag(msg, command_int->tag);
#else
