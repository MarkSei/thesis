...
#define MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_LEN 64
#define MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_MIN_LEN 64
#define MAVLINK_MSG_ID_114_LEN 64
#define MAVLINK_MSG_ID_114_MIN_LEN 64

#define MAVLINK_MSG_ID_HIL_OPTICAL_FLOW_CRC 66
#define MAVLINK_MSG_ID_114_CRC 66

#define MAVLINK_MSG_HIL_OPTICAL_FLOW_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_HIL_OPTICAL_FLOW_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_OPTICAL_FLOW { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_optical_flow_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 44, offsetof(mavlink_hil_optical_flow_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_hil_optical_flow_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_OPTICAL_FLOW { \
...
/**
 * @brief Get field padding from hil_optical_flow message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_optical_flow_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  44);
}

/**
 * @brief Get field tag from hil_optical_flow message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_optical_flow_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_hil_optical_flow_decode(const mavlink_message_t* msg, mavlink_hil_optical_flow_t* hil_optical_flow)
{
    ...
    mavlink_msg_hil_optical_flow_get_padding(msg, hil_optical_flow->padding);
    mavlink_msg_hil_optical_flow_get_tag(msg, hil_optical_flow->tag);
#else
