...
#define MAVLINK_MSG_ID_DISTANCE_SENSOR_LEN 32
#define MAVLINK_MSG_ID_DISTANCE_SENSOR_MIN_LEN 32
#define MAVLINK_MSG_ID_132_LEN 32
#define MAVLINK_MSG_ID_132_MIN_LEN 32

#define MAVLINK_MSG_ID_DISTANCE_SENSOR_CRC 210
#define MAVLINK_MSG_ID_132_CRC 210

#define MAVLINK_MSG_DISTANCE_SENSOR_FIELD_PADDING_LEN 2
#define MAVLINK_MSG_DISTANCE_SENSOR_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_DISTANCE_SENSOR { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_distance_sensor_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 2, 14, offsetof(mavlink_distance_sensor_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_distance_sensor_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_DISTANCE_SENSOR { \
...
/**
 * @brief Get field padding from distance_sensor message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_distance_sensor_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 2,  14);
}

/**
 * @brief Get field tag from distance_sensor message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_distance_sensor_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_distance_sensor_decode(const mavlink_message_t* msg, mavlink_distance_sensor_t* distance_sensor)
{
    ...
    mavlink_msg_distance_sensor_get_padding(msg, distance_sensor->padding);
    mavlink_msg_distance_sensor_get_tag(msg, distance_sensor->tag);
#else
