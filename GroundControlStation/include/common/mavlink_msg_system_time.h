...
#define MAVLINK_MSG_ID_SYSTEM_TIME_LEN 32
#define MAVLINK_MSG_ID_SYSTEM_TIME_MIN_LEN 32
#define MAVLINK_MSG_ID_2_LEN 32
#define MAVLINK_MSG_ID_2_MIN_LEN 32

#define MAVLINK_MSG_ID_SYSTEM_TIME_CRC 179
#define MAVLINK_MSG_ID_2_CRC 179

#define MAVLINK_MSG_SYSTEM_TIME_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_SYSTEM_TIME_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SYSTEM_TIME { \
    ...
    {  { "time_unix_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_system_time_t, time_unix_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 12, offsetof(mavlink_system_time_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_system_time_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SYSTEM_TIME { \
...
/**
 * @brief Get field padding from system_time message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_system_time_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  12);
}

/**
 * @brief Get field tag from system_time message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_system_time_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_system_time_decode(const mavlink_message_t* msg, mavlink_system_time_t* system_time)
{
    ...
    mavlink_msg_system_time_get_padding(msg, system_time->padding);
    mavlink_msg_system_time_get_tag(msg, system_time->tag);
#else
