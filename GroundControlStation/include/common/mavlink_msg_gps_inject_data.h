...
#define MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN 144
#define MAVLINK_MSG_ID_GPS_INJECT_DATA_MIN_LEN 144
#define MAVLINK_MSG_ID_123_LEN 144
#define MAVLINK_MSG_ID_123_MIN_LEN 144

#define MAVLINK_MSG_ID_GPS_INJECT_DATA_CRC 11
#define MAVLINK_MSG_ID_123_CRC 11

#define MAVLINK_MSG_GPS_INJECT_DATA_FIELD_DATA_LEN 110
#define MAVLINK_MSG_GPS_INJECT_DATA_FIELD_PADDING_LEN 15
#define MAVLINK_MSG_GPS_INJECT_DATA_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GPS_INJECT_DATA { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_gps_inject_data_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 15, 113, offsetof(mavlink_gps_inject_data_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 128, offsetof(mavlink_gps_inject_data_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS_INJECT_DATA { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t len, const uint8_t *data)
{
    ...
    _mav_put_uint8_t_array(buf, 113, NULL, 15);
    _mav_put_uint8_t_array(buf, 128, NULL, 16);
...
/**
 * @brief Get field padding from gps_inject_data message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps_inject_data_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 15,  113);
}

/**
 * @brief Get field tag from gps_inject_data message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_gps_inject_data_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  128);
}
...
static inline void mavlink_msg_gps_inject_data_decode(const mavlink_message_t* msg, mavlink_gps_inject_data_t* gps_inject_data)
{
    ...
    mavlink_msg_gps_inject_data_get_padding(msg, gps_inject_data->padding);
    mavlink_msg_gps_inject_data_get_tag(msg, gps_inject_data->tag);
#else
