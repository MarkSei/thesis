...
#define MAVLINK_MSG_ID_ECDH_KEY_EXCHANGE_LEN 112
#define MAVLINK_MSG_ID_ECDH_KEY_EXCHANGE_MIN_LEN 112
#define MAVLINK_MSG_ID_3_LEN 112
#define MAVLINK_MSG_ID_3_MIN_LEN 112

#define MAVLINK_MSG_ID_ECDH_KEY_EXCHANGE_CRC 20
#define MAVLINK_MSG_ID_3_CRC 20

#define MAVLINK_MSG_ECDH_KEY_EXCHANGE_FIELD_PUBLIC_KEY_LEN 72
#define MAVLINK_MSG_ECDH_KEY_EXCHANGE_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_ECDH_KEY_EXCHANGE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ECDH_KEY_EXCHANGE { \
    ...
    {  { "public_key", NULL, MAVLINK_TYPE_UINT8_T, 72, 8, offsetof(mavlink_ecdh_key_exchange_t, public_key) }, \
         ...
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 96, offsetof(mavlink_ecdh_key_exchange_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ECDH_KEY_EXCHANGE { \
...
/**
 * @brief Get field tag from ecdh_key_exchange message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_ecdh_key_exchange_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_ecdh_key_exchange_decode(const mavlink_message_t* msg, mavlink_ecdh_key_exchange_t* ecdh_key_exchange)
{
    ...
    mavlink_msg_ecdh_key_exchange_get_tag(msg, ecdh_key_exchange->tag);
#else
