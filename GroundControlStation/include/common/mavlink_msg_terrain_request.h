...
#define MAVLINK_MSG_ID_TERRAIN_REQUEST_LEN 48
#define MAVLINK_MSG_ID_TERRAIN_REQUEST_MIN_LEN 48
#define MAVLINK_MSG_ID_133_LEN 48
#define MAVLINK_MSG_ID_133_MIN_LEN 48

#define MAVLINK_MSG_ID_TERRAIN_REQUEST_CRC 172
#define MAVLINK_MSG_ID_133_CRC 172

#define MAVLINK_MSG_TERRAIN_REQUEST_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_TERRAIN_REQUEST_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_TERRAIN_REQUEST { \
    ...
    {  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_terrain_request_t, lat) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 18, offsetof(mavlink_terrain_request_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_terrain_request_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_REQUEST { \
...
/**
 * @brief Get field padding from terrain_request message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_terrain_request_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  18);
}

/**
 * @brief Get field tag from terrain_request message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_terrain_request_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_terrain_request_decode(const mavlink_message_t* msg, mavlink_terrain_request_t* terrain_request)
{
    ...
    mavlink_msg_terrain_request_get_padding(msg, terrain_request->padding);
    mavlink_msg_terrain_request_get_tag(msg, terrain_request->tag);
#else
