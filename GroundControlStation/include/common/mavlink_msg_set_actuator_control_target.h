...
typedef struct __mavlink_set_actuator_control_target_t {
 ...
 uint8_t padding[5]; /*< Padding for encryption*/
 uint8_t tag[16]; /*< 128 bit message signature*/
}) mavlink_set_actuator_control_target_t;

#define MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN 64
#define MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_MIN_LEN 64
#define MAVLINK_MSG_ID_139_LEN 64
#define MAVLINK_MSG_ID_139_MIN_LEN 64

#define MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_CRC 184
#define MAVLINK_MSG_ID_139_CRC 184

#define MAVLINK_MSG_SET_ACTUATOR_CONTROL_TARGET_FIELD_CONTROLS_LEN 8
#define MAVLINK_MSG_SET_ACTUATOR_CONTROL_TARGET_FIELD_PADDING_LEN 5
#define MAVLINK_MSG_SET_ACTUATOR_CONTROL_TARGET_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SET_ACTUATOR_CONTROL_TARGET { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_set_actuator_control_target_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 5, 43, offsetof(mavlink_set_actuator_control_target_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_set_actuator_control_target_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_ACTUATOR_CONTROL_TARGET { \
                               ...
                               uint64_t time_usec, uint8_t group_mlx, uint8_t target_system, uint8_t target_component, const float *controls)
{
    ...
    _mav_put_uint8_t_array(buf, 43, NULL, 5);
    ...
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*5);
...
/**
 * @brief Get field padding from set_actuator_control_target message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_set_actuator_control_target_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 5,  43);
}

/**
 * @brief Get field tag from set_actuator_control_target message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_set_actuator_control_target_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_set_actuator_control_target_decode(const mavlink_message_t* msg, mavlink_set_actuator_control_target_t* set_actuator_control_target)
{
    ...
    mavlink_msg_set_actuator_control_target_get_padding(msg, set_actuator_control_target->padding);
    mavlink_msg_set_actuator_control_target_get_tag(msg, set_actuator_control_target->tag);
#else
