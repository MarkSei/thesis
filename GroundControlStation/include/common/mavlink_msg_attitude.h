...
#define MAVLINK_MSG_ID_ATTITUDE_MIN_LEN 48
#define MAVLINK_MSG_ID_30_LEN 48
#define MAVLINK_MSG_ID_30_MIN_LEN 48

#define MAVLINK_MSG_ID_ATTITUDE_CRC 58
#define MAVLINK_MSG_ID_30_CRC 58

#define MAVLINK_MSG_ATTITUDE_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_ATTITUDE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_attitude_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 28, offsetof(mavlink_attitude_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_attitude_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ATTITUDE { \
...
/**
 * @brief Get field padding from attitude message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_attitude_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  28);
}

/**
 * @brief Get field tag from attitude message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_attitude_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_attitude_decode(const mavlink_message_t* msg, mavlink_attitude_t* attitude)
{
    ...
    mavlink_msg_attitude_get_padding(msg, attitude->padding);
    mavlink_msg_attitude_get_tag(msg, attitude->tag);
#else
