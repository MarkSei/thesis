...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_LEN 208
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_MIN_LEN 208
#define MAVLINK_MSG_ID_63_LEN 208
#define MAVLINK_MSG_ID_63_MIN_LEN 208

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_COV_CRC 27
#define MAVLINK_MSG_ID_63_CRC 27

#define MAVLINK_MSG_GLOBAL_POSITION_INT_COV_FIELD_COVARIANCE_LEN 36
#define MAVLINK_MSG_GLOBAL_POSITION_INT_COV_FIELD_PADDING_LEN 11
#define MAVLINK_MSG_GLOBAL_POSITION_INT_COV_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT_COV { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_global_position_int_cov_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 181, offsetof(mavlink_global_position_int_cov_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 192, offsetof(mavlink_global_position_int_cov_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT_COV { \
                               ...
                               uint64_t time_usec, uint8_t estimator_type, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, float vx, float vy, float vz, const float *covariance)
{
    ...
    _mav_put_uint8_t_array(buf, 181, NULL, 11);
    _mav_put_uint8_t_array(buf, 192, NULL, 16);
...
/**
 * @brief Get field padding from global_position_int_cov message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_global_position_int_cov_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  181);
}

/**
 * @brief Get field tag from global_position_int_cov message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_global_position_int_cov_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  192);
}
...
static inline void mavlink_msg_global_position_int_cov_decode(const mavlink_message_t* msg, mavlink_global_position_int_cov_t* global_position_int_cov)
{
    ...
    mavlink_msg_global_position_int_cov_get_padding(msg, global_position_int_cov->padding);
    mavlink_msg_global_position_int_cov_get_tag(msg, global_position_int_cov->tag);
#else
