...
#define MAVLINK_MSG_ID_POWER_STATUS_LEN 32
#define MAVLINK_MSG_ID_POWER_STATUS_MIN_LEN 32
#define MAVLINK_MSG_ID_125_LEN 32
#define MAVLINK_MSG_ID_125_MIN_LEN 32

#define MAVLINK_MSG_ID_POWER_STATUS_CRC 27
#define MAVLINK_MSG_ID_125_CRC 27

#define MAVLINK_MSG_POWER_STATUS_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_POWER_STATUS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_POWER_STATUS { \
    ...
    {  { "Vcc", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_power_status_t, Vcc) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 6, offsetof(mavlink_power_status_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_power_status_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_POWER_STATUS { \
...
/**
 * @brief Get field padding from power_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_power_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  6);
}

/**
 * @brief Get field tag from power_status message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_power_status_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_power_status_decode(const mavlink_message_t* msg, mavlink_power_status_t* power_status)
{
    ...
    mavlink_msg_power_status_get_padding(msg, power_status->padding);
    mavlink_msg_power_status_get_tag(msg, power_status->tag);
#else
