...
#define MAVLINK_MSG_ID_TERRAIN_REPORT_LEN 48
#define MAVLINK_MSG_ID_TERRAIN_REPORT_MIN_LEN 48
#define MAVLINK_MSG_ID_136_LEN 48
#define MAVLINK_MSG_ID_136_MIN_LEN 48

#define MAVLINK_MSG_ID_TERRAIN_REPORT_CRC 116
#define MAVLINK_MSG_ID_136_CRC 116

#define MAVLINK_MSG_TERRAIN_REPORT_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_TERRAIN_REPORT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_TERRAIN_REPORT { \
    ...
    {  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_terrain_report_t, lat) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 22, offsetof(mavlink_terrain_report_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_terrain_report_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_REPORT { \
...
/**
 * @brief Get field padding from terrain_report message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_terrain_report_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  22);
}

/**
 * @brief Get field tag from terrain_report message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_terrain_report_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_terrain_report_decode(const mavlink_message_t* msg, mavlink_terrain_report_t* terrain_report)
{
    ...
    mavlink_msg_terrain_report_get_padding(msg, terrain_report->padding);
    mavlink_msg_terrain_report_get_tag(msg, terrain_report->tag);
#else
