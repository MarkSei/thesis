...
#define MAVLINK_MSG_ID_RAW_PRESSURE_LEN 48
#define MAVLINK_MSG_ID_RAW_PRESSURE_MIN_LEN 48
#define MAVLINK_MSG_ID_28_LEN 48
#define MAVLINK_MSG_ID_28_MIN_LEN 48

#define MAVLINK_MSG_ID_RAW_PRESSURE_CRC 21
#define MAVLINK_MSG_ID_28_CRC 21

#define MAVLINK_MSG_RAW_PRESSURE_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_RAW_PRESSURE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_RAW_PRESSURE { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_raw_pressure_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_raw_pressure_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_raw_pressure_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RAW_PRESSURE { \
...
/**
 * @brief Get field padding from raw_pressure message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_raw_pressure_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  16);
}

/**
 * @brief Get field tag from raw_pressure message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_raw_pressure_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_raw_pressure_decode(const mavlink_message_t* msg, mavlink_raw_pressure_t* raw_pressure)
{
    ...
    mavlink_msg_raw_pressure_get_padding(msg, raw_pressure->padding);
    mavlink_msg_raw_pressure_get_tag(msg, raw_pressure->tag);
#else
