...
#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_LEN 48
#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_MIN_LEN 48
#define MAVLINK_MSG_ID_5_LEN 48
#define MAVLINK_MSG_ID_5_MIN_LEN 48

#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_CRC 69
#define MAVLINK_MSG_ID_5_CRC 69

#define MAVLINK_MSG_CHANGE_OPERATOR_CONTROL_FIELD_PASSKEY_LEN 25
#define MAVLINK_MSG_CHANGE_OPERATOR_CONTROL_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_CHANGE_OPERATOR_CONTROL_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_CHANGE_OPERATOR_CONTROL { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_change_operator_control_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 28, offsetof(mavlink_change_operator_control_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_change_operator_control_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CHANGE_OPERATOR_CONTROL { \
...
/**
 * @brief Get field padding from change_operator_control message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_change_operator_control_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  28);
}

/**
 * @brief Get field tag from change_operator_control message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_change_operator_control_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_change_operator_control_decode(const mavlink_message_t* msg, mavlink_change_operator_control_t* change_operator_control)
{
    ...
    mavlink_msg_change_operator_control_get_padding(msg, change_operator_control->padding);
    mavlink_msg_change_operator_control_get_tag(msg, change_operator_control->tag);
#else
