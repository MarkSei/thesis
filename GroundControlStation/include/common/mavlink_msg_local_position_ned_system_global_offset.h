...
#define MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_LEN 48
#define MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_MIN_LEN 48
#define MAVLINK_MSG_ID_89_LEN 48
#define MAVLINK_MSG_ID_89_MIN_LEN 48

#define MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_CRC 139
#define MAVLINK_MSG_ID_89_CRC 139

#define MAVLINK_MSG_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_local_position_ned_system_global_offset_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 28, offsetof(mavlink_local_position_ned_system_global_offset_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_local_position_ned_system_global_offset_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET { \
                               ...
                               uint32_t time_boot_ms, float x, float y, float z, float roll, float pitch, float yaw)
{
    ...
    _mav_put_uint8_t_array(buf, 28, NULL, 4);
    ...
    packet.pitch = pitch;
    packet.yaw = yaw;
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*4);
...
/**
 * @brief Get field padding from local_position_ned_system_global_offset message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_local_position_ned_system_global_offset_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  28);
}

/**
 * @brief Get field tag from local_position_ned_system_global_offset message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_local_position_ned_system_global_offset_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_local_position_ned_system_global_offset_decode(const mavlink_message_t* msg, mavlink_local_position_ned_system_global_offset_t* local_position_ned_system_global_offset)
{
    ...
    mavlink_msg_local_position_ned_system_global_offset_get_padding(msg, local_position_ned_system_global_offset->padding);
    mavlink_msg_local_position_ned_system_global_offset_get_tag(msg, local_position_ned_system_global_offset->tag);
#else
