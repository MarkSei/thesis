...
#define MAVLINK_MSG_ID_GPS2_RAW_LEN 64
#define MAVLINK_MSG_ID_GPS2_RAW_MIN_LEN 64
#define MAVLINK_MSG_ID_124_LEN 64
#define MAVLINK_MSG_ID_124_MIN_LEN 64

#define MAVLINK_MSG_ID_GPS2_RAW_CRC 21
#define MAVLINK_MSG_ID_124_CRC 21

#define MAVLINK_MSG_GPS2_RAW_FIELD_PADDING_LEN 13
#define MAVLINK_MSG_GPS2_RAW_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GPS2_RAW { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_gps2_raw_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 35, offsetof(mavlink_gps2_raw_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_gps2_raw_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS2_RAW { \
...
/**
 * @brief Get field padding from gps2_raw message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps2_raw_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  35);
}

/**
 * @brief Get field tag from gps2_raw message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_gps2_raw_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_gps2_raw_decode(const mavlink_message_t* msg, mavlink_gps2_raw_t* gps2_raw)
{
    ...
    mavlink_msg_gps2_raw_get_padding(msg, gps2_raw->padding);
    mavlink_msg_gps2_raw_get_tag(msg, gps2_raw->tag);
#else
