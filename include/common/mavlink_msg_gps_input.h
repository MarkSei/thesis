...
#define MAVLINK_MSG_ID_GPS_INPUT_LEN 80
#define MAVLINK_MSG_ID_GPS_INPUT_MIN_LEN 80
#define MAVLINK_MSG_ID_232_LEN 80
#define MAVLINK_MSG_ID_232_MIN_LEN 80

#define MAVLINK_MSG_ID_GPS_INPUT_CRC 32
#define MAVLINK_MSG_ID_232_CRC 32

#define MAVLINK_MSG_GPS_INPUT_FIELD_PADDING_LEN 1
#define MAVLINK_MSG_GPS_INPUT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GPS_INPUT { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_gps_input_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 1, 63, offsetof(mavlink_gps_input_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_gps_input_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS_INPUT { \
                               ...
                               uint64_t time_usec, uint8_t gps_id, uint16_t ignore_flags, uint32_t time_week_ms, uint16_t time_week, uint8_t fix_type, int32_t lat, int32_t lon, float alt, float hdop, float vdop, float vn, float ve, float vd, float speed_accuracy, float horiz_accuracy, float vert_accuracy, uint8_t satellites_visible)
{
    ...
    _mav_put_uint8_t_array(buf, 63, NULL, 1);
...
/**
 * @brief Get field padding from gps_input message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps_input_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 1,  63);
}

/**
 * @brief Get field tag from gps_input message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_gps_input_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_gps_input_decode(const mavlink_message_t* msg, mavlink_gps_input_t* gps_input)
{
    ...
    mavlink_msg_gps_input_get_padding(msg, gps_input->padding);
    mavlink_msg_gps_input_get_tag(msg, gps_input->tag);
#else
