...
#define MAVLINK_MSG_ID_COMMAND_LONG_LEN 64
#define MAVLINK_MSG_ID_COMMAND_LONG_MIN_LEN 64
#define MAVLINK_MSG_ID_76_LEN 64
#define MAVLINK_MSG_ID_76_MIN_LEN 64

#define MAVLINK_MSG_ID_COMMAND_LONG_CRC 166
#define MAVLINK_MSG_ID_76_CRC 166

#define MAVLINK_MSG_COMMAND_LONG_FIELD_PADDING_LEN 15
#define MAVLINK_MSG_COMMAND_LONG_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_COMMAND_LONG { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 30, offsetof(mavlink_command_long_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 15, 33, offsetof(mavlink_command_long_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_command_long_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_COMMAND_LONG { \
...
/**
 * @brief Get field padding from command_long message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_command_long_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 15,  33);
}

/**
 * @brief Get field tag from command_long message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_command_long_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_command_long_decode(const mavlink_message_t* msg, mavlink_command_long_t* command_long)
{
    ...
    mavlink_msg_command_long_get_padding(msg, command_long->padding);
    mavlink_msg_command_long_get_tag(msg, command_long->tag);
#else
