...
#define MAVLINK_MSG_ID_LOCAL_POSITION_NED_MIN_LEN 48
#define MAVLINK_MSG_ID_32_LEN 48
#define MAVLINK_MSG_ID_32_MIN_LEN 48

#define MAVLINK_MSG_ID_LOCAL_POSITION_NED_CRC 76
#define MAVLINK_MSG_ID_32_CRC 76

#define MAVLINK_MSG_LOCAL_POSITION_NED_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_LOCAL_POSITION_NED_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_local_position_ned_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 28, offsetof(mavlink_local_position_ned_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_local_position_ned_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOCAL_POSITION_NED { \
...
/**
 * @brief Get field padding from local_position_ned message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_local_position_ned_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  28);
}

/**
 * @brief Get field tag from local_position_ned message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_local_position_ned_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_local_position_ned_decode(const mavlink_message_t* msg, mavlink_local_position_ned_t* local_position_ned)
{
    ...
    mavlink_msg_local_position_ned_get_padding(msg, local_position_ned->padding);
    mavlink_msg_local_position_ned_get_tag(msg, local_position_ned->tag);
#else
