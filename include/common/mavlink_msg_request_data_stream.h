...
#define MAVLINK_MSG_ID_REQUEST_DATA_STREAM_LEN 32
#define MAVLINK_MSG_ID_REQUEST_DATA_STREAM_MIN_LEN 32
#define MAVLINK_MSG_ID_66_LEN 32
#define MAVLINK_MSG_ID_66_MIN_LEN 32

#define MAVLINK_MSG_ID_REQUEST_DATA_STREAM_CRC 209
#define MAVLINK_MSG_ID_66_CRC 209

#define MAVLINK_MSG_REQUEST_DATA_STREAM_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_REQUEST_DATA_STREAM_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_REQUEST_DATA_STREAM { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_request_data_stream_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 6, offsetof(mavlink_request_data_stream_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_request_data_stream_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_REQUEST_DATA_STREAM { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint8_t req_stream_id, uint16_t req_message_rate, uint8_t start_stop)
{
    ...
    _mav_put_uint8_t_array(buf, 6, NULL, 10);
...
/**
 * @brief Get field padding from request_data_stream message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_request_data_stream_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  6);
}

/**
 * @brief Get field tag from request_data_stream message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_request_data_stream_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_request_data_stream_decode(const mavlink_message_t* msg, mavlink_request_data_stream_t* request_data_stream)
{
    ...
    mavlink_msg_request_data_stream_get_padding(msg, request_data_stream->padding);
    mavlink_msg_request_data_stream_get_tag(msg, request_data_stream->tag);
#else
