...
#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_LEN 48
#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_MIN_LEN 48
#define MAVLINK_MSG_ID_20_LEN 48
#define MAVLINK_MSG_ID_20_MIN_LEN 48

#define MAVLINK_MSG_ID_PARAM_REQUEST_READ_CRC 198
#define MAVLINK_MSG_ID_20_CRC 198

#define MAVLINK_MSG_PARAM_REQUEST_READ_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_REQUEST_READ_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_PARAM_REQUEST_READ_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_param_request_read_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 20, offsetof(mavlink_param_request_read_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_param_request_read_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_REQUEST_READ { \
...
/**
 * @brief Get field padding from param_request_read message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_request_read_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  20);
}

/**
 * @brief Get field tag from param_request_read message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_param_request_read_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_param_request_read_decode(const mavlink_message_t* msg, mavlink_param_request_read_t* param_request_read)
{
    ...
    mavlink_msg_param_request_read_get_padding(msg, param_request_read->padding);
    mavlink_msg_param_request_read_get_tag(msg, param_request_read->tag);
#else
