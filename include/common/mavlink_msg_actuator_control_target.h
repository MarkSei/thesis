...
#define MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_LEN 64
#define MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_MIN_LEN 64
#define MAVLINK_MSG_ID_140_LEN 64
#define MAVLINK_MSG_ID_140_MIN_LEN 64

#define MAVLINK_MSG_ID_ACTUATOR_CONTROL_TARGET_CRC 21
#define MAVLINK_MSG_ID_140_CRC 21

#define MAVLINK_MSG_ACTUATOR_CONTROL_TARGET_FIELD_CONTROLS_LEN 8
#define MAVLINK_MSG_ACTUATOR_CONTROL_TARGET_FIELD_PADDING_LEN 7
#define MAVLINK_MSG_ACTUATOR_CONTROL_TARGET_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ACTUATOR_CONTROL_TARGET { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_actuator_control_target_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 41, offsetof(mavlink_actuator_control_target_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_actuator_control_target_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ACTUATOR_CONTROL_TARGET { \
                               ...
                               uint64_t time_usec, uint8_t group_mlx, const float *controls)
{
    ...
    _mav_put_uint8_t_array(buf, 41, NULL, 7);
    ...
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*7);
...
/**
 * @brief Get field padding from actuator_control_target message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_actuator_control_target_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 7,  41);
}

/**
 * @brief Get field tag from actuator_control_target message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_actuator_control_target_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_actuator_control_target_decode(const mavlink_message_t* msg, mavlink_actuator_control_target_t* actuator_control_target)
{
    ...
    mavlink_msg_actuator_control_target_get_padding(msg, actuator_control_target->padding);
    mavlink_msg_actuator_control_target_get_tag(msg, actuator_control_target->tag);
#else
