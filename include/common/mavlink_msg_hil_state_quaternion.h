...
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN 96
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_MIN_LEN 96
#define MAVLINK_MSG_ID_115_LEN 96
#define MAVLINK_MSG_ID_115_MIN_LEN 96

#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC 81
#define MAVLINK_MSG_ID_115_CRC 81

#define MAVLINK_MSG_HIL_STATE_QUATERNION_FIELD_ATTITUDE_QUATERNION_LEN 4
#define MAVLINK_MSG_HIL_STATE_QUATERNION_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_HIL_STATE_QUATERNION_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_state_quaternion_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_hil_state_quaternion_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 80, offsetof(mavlink_hil_state_quaternion_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION { \
                               ...
                               uint64_t time_usec, const float *attitude_quaternion, float rollspeed, float pitchspeed, float yawspeed, int32_t lat, int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, uint16_t ind_airspeed, uint16_t true_airspeed, int16_t xacc, int16_t yacc, int16_t zacc)
{
    ...
    _mav_put_uint8_t_array(buf, 80, NULL, 16);
...
/**
 * @brief Get field padding from hil_state_quaternion message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  64);
}

/**
 * @brief Get field tag from hil_state_quaternion message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  80);
}
...
static inline void mavlink_msg_hil_state_quaternion_decode(const mavlink_message_t* msg, mavlink_hil_state_quaternion_t* hil_state_quaternion)
{
    ...
    mavlink_msg_hil_state_quaternion_get_padding(msg, hil_state_quaternion->padding);
    mavlink_msg_hil_state_quaternion_get_tag(msg, hil_state_quaternion->tag);
#else
