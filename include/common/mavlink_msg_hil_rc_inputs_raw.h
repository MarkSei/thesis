...
#define MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_LEN 64
#define MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_MIN_LEN 64
#define MAVLINK_MSG_ID_92_LEN 64
#define MAVLINK_MSG_ID_92_MIN_LEN 64

#define MAVLINK_MSG_ID_HIL_RC_INPUTS_RAW_CRC 152
#define MAVLINK_MSG_ID_92_CRC 152

#define MAVLINK_MSG_HIL_RC_INPUTS_RAW_FIELD_PADDING_LEN 15
#define MAVLINK_MSG_HIL_RC_INPUTS_RAW_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_RC_INPUTS_RAW { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_rc_inputs_raw_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 15, 33, offsetof(mavlink_hil_rc_inputs_raw_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_hil_rc_inputs_raw_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_RC_INPUTS_RAW { \
                               ...
                               uint64_t time_usec, uint16_t chan1_raw, uint16_t chan2_raw, uint16_t chan3_raw, uint16_t chan4_raw, uint16_t chan5_raw, uint16_t chan6_raw, uint16_t chan7_raw, uint16_t chan8_raw, uint16_t chan9_raw, uint16_t chan10_raw, uint16_t chan11_raw, uint16_t chan12_raw, uint8_t rssi)
{
    ...
    _mav_put_uint8_t_array(buf, 33, NULL, 15);
...
/**
 * @brief Get field padding from hil_rc_inputs_raw message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_rc_inputs_raw_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 15,  33);
}

/**
 * @brief Get field tag from hil_rc_inputs_raw message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_rc_inputs_raw_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_hil_rc_inputs_raw_decode(const mavlink_message_t* msg, mavlink_hil_rc_inputs_raw_t* hil_rc_inputs_raw)
{
    ...
    mavlink_msg_hil_rc_inputs_raw_get_padding(msg, hil_rc_inputs_raw->padding);
    mavlink_msg_hil_rc_inputs_raw_get_tag(msg, hil_rc_inputs_raw->tag);
#else
