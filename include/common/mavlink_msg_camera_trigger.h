...
#define MAVLINK_MSG_ID_CAMERA_TRIGGER_LEN 32
#define MAVLINK_MSG_ID_CAMERA_TRIGGER_MIN_LEN 32
#define MAVLINK_MSG_ID_112_LEN 32
#define MAVLINK_MSG_ID_112_MIN_LEN 32

#define MAVLINK_MSG_ID_CAMERA_TRIGGER_CRC 98
#define MAVLINK_MSG_ID_112_CRC 98

#define MAVLINK_MSG_CAMERA_TRIGGER_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_CAMERA_TRIGGER_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_CAMERA_TRIGGER { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_camera_trigger_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 12, offsetof(mavlink_camera_trigger_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_camera_trigger_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CAMERA_TRIGGER { \
...
/**
 * @brief Get field padding from camera_trigger message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_camera_trigger_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  12);
}

/**
 * @brief Get field tag from camera_trigger message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_camera_trigger_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_camera_trigger_decode(const mavlink_message_t* msg, mavlink_camera_trigger_t* camera_trigger)
{
    ...
    mavlink_msg_camera_trigger_get_padding(msg, camera_trigger->padding);
    mavlink_msg_camera_trigger_get_tag(msg, camera_trigger->tag);
#else
