...
#define MAVLINK_MSG_ID_NAMED_VALUE_INT_LEN 48
#define MAVLINK_MSG_ID_NAMED_VALUE_INT_MIN_LEN 48
#define MAVLINK_MSG_ID_252_LEN 48
#define MAVLINK_MSG_ID_252_MIN_LEN 48

#define MAVLINK_MSG_ID_NAMED_VALUE_INT_CRC 157
#define MAVLINK_MSG_ID_252_CRC 157

#define MAVLINK_MSG_NAMED_VALUE_INT_FIELD_NAME_LEN 10
#define MAVLINK_MSG_NAMED_VALUE_INT_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_NAMED_VALUE_INT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_named_value_int_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 18, offsetof(mavlink_named_value_int_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_named_value_int_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_INT { \
...
/**
 * @brief Get field padding from named_value_int message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_named_value_int_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  18);
}

/**
 * @brief Get field tag from named_value_int message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_named_value_int_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_named_value_int_decode(const mavlink_message_t* msg, mavlink_named_value_int_t* named_value_int)
{
    ...
    mavlink_msg_named_value_int_get_padding(msg, named_value_int->padding);
    mavlink_msg_named_value_int_get_tag(msg, named_value_int->tag);
#else
