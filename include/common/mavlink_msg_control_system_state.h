...
#define MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_LEN 128
#define MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_MIN_LEN 128
#define MAVLINK_MSG_ID_146_LEN 128
#define MAVLINK_MSG_ID_146_MIN_LEN 128

#define MAVLINK_MSG_ID_CONTROL_SYSTEM_STATE_CRC 204
#define MAVLINK_MSG_ID_146_CRC 204
...
#define MAVLINK_MSG_CONTROL_SYSTEM_STATE_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_CONTROL_SYSTEM_STATE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_CONTROL_SYSTEM_STATE { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_control_system_state_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 100, offsetof(mavlink_control_system_state_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 112, offsetof(mavlink_control_system_state_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CONTROL_SYSTEM_STATE { \
                               ...
                               uint64_t time_usec, float x_acc, float y_acc, float z_acc, float x_vel, float y_vel, float z_vel, float x_pos, float y_pos, float z_pos, float airspeed, const float *vel_variance, const float *pos_variance, const float *q, float roll_rate, float pitch_rate, float yaw_rate)
{
    ...
    _mav_put_uint8_t_array(buf, 100, NULL, 12);
    _mav_put_uint8_t_array(buf, 112, NULL, 16);
    ...
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*12);
...
/**
 * @brief Get field padding from control_system_state message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_control_system_state_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  100);
}

/**
 * @brief Get field tag from control_system_state message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_control_system_state_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  112);
}
...
static inline void mavlink_msg_control_system_state_decode(const mavlink_message_t* msg, mavlink_control_system_state_t* control_system_state)
{
    ...
    mavlink_msg_control_system_state_get_padding(msg, control_system_state->padding);
    mavlink_msg_control_system_state_get_tag(msg, control_system_state->tag);
#else
