...
#define MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_LEN 48
#define MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_MIN_LEN 48
#define MAVLINK_MSG_ID_103_LEN 48
#define MAVLINK_MSG_ID_103_MIN_LEN 48

#define MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE_CRC 249
#define MAVLINK_MSG_ID_103_CRC 249

#define MAVLINK_MSG_VISION_SPEED_ESTIMATE_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_VISION_SPEED_ESTIMATE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_VISION_SPEED_ESTIMATE { \
    ...
    {  { "usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_vision_speed_estimate_t, usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 20, offsetof(mavlink_vision_speed_estimate_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_vision_speed_estimate_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_VISION_SPEED_ESTIMATE { \
                               ...
                               uint64_t usec, float x, float y, float z)
{
    ...
    _mav_put_uint8_t_array(buf, 20, NULL, 12);
...
/**
 * @brief Get field padding from vision_speed_estimate message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_vision_speed_estimate_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  20);
}

/**
 * @brief Get field tag from vision_speed_estimate message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_vision_speed_estimate_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_vision_speed_estimate_decode(const mavlink_message_t* msg, mavlink_vision_speed_estimate_t* vision_speed_estimate)
{
    ...
    mavlink_msg_vision_speed_estimate_get_padding(msg, vision_speed_estimate->padding);
    mavlink_msg_vision_speed_estimate_get_tag(msg, vision_speed_estimate->tag);
#else
