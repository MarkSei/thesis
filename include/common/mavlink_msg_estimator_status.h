...
typedef struct __mavlink_estimator_status_t {
 ...
 uint8_t padding[6]; /*< Padding for encryption*/
 uint8_t tag[16]; /*< 128 bit message signature*/
}) mavlink_estimator_status_t;

#define MAVLINK_MSG_ID_ESTIMATOR_STATUS_LEN 64
#define MAVLINK_MSG_ID_ESTIMATOR_STATUS_MIN_LEN 64
#define MAVLINK_MSG_ID_230_LEN 64
#define MAVLINK_MSG_ID_230_MIN_LEN 64

#define MAVLINK_MSG_ID_ESTIMATOR_STATUS_CRC 76
#define MAVLINK_MSG_ID_230_CRC 76

#define MAVLINK_MSG_ESTIMATOR_STATUS_FIELD_PADDING_LEN 6
#define MAVLINK_MSG_ESTIMATOR_STATUS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_STATUS { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_estimator_status_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 6, 42, offsetof(mavlink_estimator_status_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_estimator_status_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_STATUS { \
                               ...
                               uint64_t time_usec, uint16_t flags, float vel_ratio, float pos_horiz_ratio, float pos_vert_ratio, float mag_ratio, float hagl_ratio, float tas_ratio, float pos_horiz_accuracy, float pos_vert_accuracy)
{
    ...
    _mav_put_uint8_t_array(buf, 42, NULL, 6);
    ...
    packet.flags = flags;
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*6);
...
/**
 * @brief Get field padding from estimator_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_estimator_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 6,  42);
}

/**
 * @brief Get field tag from estimator_status message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_estimator_status_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_estimator_status_decode(const mavlink_message_t* msg, mavlink_estimator_status_t* estimator_status)
{
    ...
    mavlink_msg_estimator_status_get_padding(msg, estimator_status->padding);
    mavlink_msg_estimator_status_get_tag(msg, estimator_status->tag);
#else
