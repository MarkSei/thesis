...
#define MAVLINK_MSG_ID_SERIAL_CONTROL_LEN 96
#define MAVLINK_MSG_ID_SERIAL_CONTROL_MIN_LEN 96
#define MAVLINK_MSG_ID_126_LEN 96
#define MAVLINK_MSG_ID_126_MIN_LEN 96

#define MAVLINK_MSG_ID_SERIAL_CONTROL_CRC 44
#define MAVLINK_MSG_ID_126_CRC 44

#define MAVLINK_MSG_SERIAL_CONTROL_FIELD_DATA_LEN 70
#define MAVLINK_MSG_SERIAL_CONTROL_FIELD_PADDING_LEN 1
#define MAVLINK_MSG_SERIAL_CONTROL_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SERIAL_CONTROL { \
    ...
    {  { "device", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_serial_control_t, device) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 1, 79, offsetof(mavlink_serial_control_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 80, offsetof(mavlink_serial_control_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SERIAL_CONTROL { \
                               ...
                               uint8_t device, uint8_t flags, uint16_t timeout, uint32_t baudrate, uint8_t count, const uint8_t *data)
{
    ...
    _mav_put_uint8_t_array(buf, 79, NULL, 1);
...
/**
 * @brief Get field padding from serial_control message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_serial_control_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 1,  79);
}

/**
 * @brief Get field tag from serial_control message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_serial_control_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_serial_control_decode(const mavlink_message_t* msg, mavlink_serial_control_t* serial_control)
{
    ...
    mavlink_msg_serial_control_get_padding(msg, serial_control->padding);
    mavlink_msg_serial_control_get_tag(msg, serial_control->tag);
#else
