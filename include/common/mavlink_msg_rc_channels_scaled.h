...
#define MAVLINK_MSG_ID_RC_CHANNELS_SCALED_LEN 48
#define MAVLINK_MSG_ID_RC_CHANNELS_SCALED_MIN_LEN 48
#define MAVLINK_MSG_ID_34_LEN 48
#define MAVLINK_MSG_ID_34_MIN_LEN 48

#define MAVLINK_MSG_ID_RC_CHANNELS_SCALED_CRC 62
#define MAVLINK_MSG_ID_34_CRC 62

#define MAVLINK_MSG_RC_CHANNELS_SCALED_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_RC_CHANNELS_SCALED_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_SCALED { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_rc_channels_scaled_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 22, offsetof(mavlink_rc_channels_scaled_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_rc_channels_scaled_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_RC_CHANNELS_SCALED { \
...
/**
 * @brief Get field padding from rc_channels_scaled message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_rc_channels_scaled_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  22);
}

/**
 * @brief Get field tag from rc_channels_scaled message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_rc_channels_scaled_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_rc_channels_scaled_decode(const mavlink_message_t* msg, mavlink_rc_channels_scaled_t* rc_channels_scaled)
{
    ...
    mavlink_msg_rc_channels_scaled_get_padding(msg, rc_channels_scaled->padding);
    mavlink_msg_rc_channels_scaled_get_tag(msg, rc_channels_scaled->tag);
#else
