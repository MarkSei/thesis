...
#define MAVLINK_MSG_ID_HIL_CONTROLS_LEN 64
#define MAVLINK_MSG_ID_HIL_CONTROLS_MIN_LEN 64
#define MAVLINK_MSG_ID_91_LEN 64
#define MAVLINK_MSG_ID_91_MIN_LEN 64

#define MAVLINK_MSG_ID_HIL_CONTROLS_CRC 133
#define MAVLINK_MSG_ID_91_CRC 133

#define MAVLINK_MSG_HIL_CONTROLS_FIELD_PADDING_LEN 6
#define MAVLINK_MSG_HIL_CONTROLS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_CONTROLS { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_controls_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 6, 42, offsetof(mavlink_hil_controls_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_hil_controls_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_CONTROLS { \
...
/**
 * @brief Get field padding from hil_controls message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_controls_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 6,  42);
}

/**
 * @brief Get field tag from hil_controls message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_controls_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_hil_controls_decode(const mavlink_message_t* msg, mavlink_hil_controls_t* hil_controls)
{
    ...
    mavlink_msg_hil_controls_get_padding(msg, hil_controls->padding);
    mavlink_msg_hil_controls_get_tag(msg, hil_controls->tag);
#else
