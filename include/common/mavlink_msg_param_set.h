...
#define MAVLINK_MSG_ID_PARAM_SET_LEN 48
#define MAVLINK_MSG_ID_PARAM_SET_MIN_LEN 48
#define MAVLINK_MSG_ID_23_LEN 48
#define MAVLINK_MSG_ID_23_MIN_LEN 48

#define MAVLINK_MSG_ID_PARAM_SET_CRC 147
#define MAVLINK_MSG_ID_23_CRC 147

#define MAVLINK_MSG_PARAM_SET_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_SET_FIELD_PADDING_LEN 9
#define MAVLINK_MSG_PARAM_SET_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_param_set_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 9, 23, offsetof(mavlink_param_set_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_param_set_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_SET { \
                               ...
                               uint8_t target_system, uint8_t target_component, const char *param_id, float param_value, uint8_t param_type)
{
    ...
    _mav_put_uint8_t_array(buf, 23, NULL, 9);
...
/**
 * @brief Get field padding from param_set message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_set_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 9,  23);
}

/**
 * @brief Get field tag from param_set message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_param_set_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_param_set_decode(const mavlink_message_t* msg, mavlink_param_set_t* param_set)
{
    ...
    mavlink_msg_param_set_get_padding(msg, param_set->padding);
    mavlink_msg_param_set_get_tag(msg, param_set->tag);
#else
