...
#define MAVLINK_MSG_ID_AUTH_KEY_LEN 64
#define MAVLINK_MSG_ID_AUTH_KEY_MIN_LEN 64
#define MAVLINK_MSG_ID_7_LEN 64
#define MAVLINK_MSG_ID_7_MIN_LEN 64

#define MAVLINK_MSG_ID_AUTH_KEY_CRC 210
#define MAVLINK_MSG_ID_7_CRC 210

#define MAVLINK_MSG_AUTH_KEY_FIELD_KEY_LEN 32
#define MAVLINK_MSG_AUTH_KEY_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_AUTH_KEY_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_AUTH_KEY { \
    ...
    {  { "key", NULL, MAVLINK_TYPE_CHAR, 32, 0, offsetof(mavlink_auth_key_t, key) }, \
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_auth_key_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_auth_key_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_AUTH_KEY { \
...
/**
 * @brief Get field padding from auth_key message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_auth_key_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  32);
}

/**
 * @brief Get field tag from auth_key message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_auth_key_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_auth_key_decode(const mavlink_message_t* msg, mavlink_auth_key_t* auth_key)
{
    ...
    mavlink_msg_auth_key_get_padding(msg, auth_key->padding);
    mavlink_msg_auth_key_get_tag(msg, auth_key->tag);
#else
