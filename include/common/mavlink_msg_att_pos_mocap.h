...
#define MAVLINK_MSG_ID_ATT_POS_MOCAP_LEN 64
#define MAVLINK_MSG_ID_ATT_POS_MOCAP_MIN_LEN 64
#define MAVLINK_MSG_ID_138_LEN 64
#define MAVLINK_MSG_ID_138_MIN_LEN 64

#define MAVLINK_MSG_ID_ATT_POS_MOCAP_CRC 178
#define MAVLINK_MSG_ID_138_CRC 178

#define MAVLINK_MSG_ATT_POS_MOCAP_FIELD_Q_LEN 4
#define MAVLINK_MSG_ATT_POS_MOCAP_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_ATT_POS_MOCAP_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ATT_POS_MOCAP { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_att_pos_mocap_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 36, offsetof(mavlink_att_pos_mocap_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_att_pos_mocap_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ATT_POS_MOCAP { \
...
/**
 * @brief Get field padding from att_pos_mocap message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_att_pos_mocap_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  36);
}

/**
 * @brief Get field tag from att_pos_mocap message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_att_pos_mocap_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_att_pos_mocap_decode(const mavlink_message_t* msg, mavlink_att_pos_mocap_t* att_pos_mocap)
{
    ...
    mavlink_msg_att_pos_mocap_get_padding(msg, att_pos_mocap->padding);
    mavlink_msg_att_pos_mocap_get_tag(msg, att_pos_mocap->tag);
#else
