...
#define MAVLINK_MSG_ID_MEMORY_VECT_LEN 64
#define MAVLINK_MSG_ID_MEMORY_VECT_MIN_LEN 64
#define MAVLINK_MSG_ID_249_LEN 64
#define MAVLINK_MSG_ID_249_MIN_LEN 64

#define MAVLINK_MSG_ID_MEMORY_VECT_CRC 21
#define MAVLINK_MSG_ID_249_CRC 21

#define MAVLINK_MSG_MEMORY_VECT_FIELD_VALUE_LEN 32
#define MAVLINK_MSG_MEMORY_VECT_FIELD_PADDING_LEN 12
#define MAVLINK_MSG_MEMORY_VECT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MEMORY_VECT { \
    ...
    {  { "address", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_memory_vect_t, address) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 12, 36, offsetof(mavlink_memory_vect_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_memory_vect_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MEMORY_VECT { \
...
/**
 * @brief Get field padding from memory_vect message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_memory_vect_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 12,  36);
}

/**
 * @brief Get field tag from memory_vect message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_memory_vect_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_memory_vect_decode(const mavlink_message_t* msg, mavlink_memory_vect_t* memory_vect)
{
    ...
    mavlink_msg_memory_vect_get_padding(msg, memory_vect->padding);
    mavlink_msg_memory_vect_get_tag(msg, memory_vect->tag);
#else
