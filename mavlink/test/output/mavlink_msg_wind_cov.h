...
#define MAVLINK_MSG_ID_WIND_COV_LEN 64
#define MAVLINK_MSG_ID_WIND_COV_MIN_LEN 64
#define MAVLINK_MSG_ID_231_LEN 64
#define MAVLINK_MSG_ID_231_MIN_LEN 64

#define MAVLINK_MSG_ID_WIND_COV_CRC 72
#define MAVLINK_MSG_ID_231_CRC 72

#define MAVLINK_MSG_WIND_COV_FIELD_PADDING_LEN 8
#define MAVLINK_MSG_WIND_COV_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_WIND_COV { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_wind_cov_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 8, 40, offsetof(mavlink_wind_cov_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_wind_cov_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_WIND_COV { \
...
/**
 * @brief Get field padding from wind_cov message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_wind_cov_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 8,  40);
}

/**
 * @brief Get field tag from wind_cov message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_wind_cov_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_wind_cov_decode(const mavlink_message_t* msg, mavlink_wind_cov_t* wind_cov)
{
    ...
    mavlink_msg_wind_cov_get_padding(msg, wind_cov->padding);
    mavlink_msg_wind_cov_get_tag(msg, wind_cov->tag);
#else
