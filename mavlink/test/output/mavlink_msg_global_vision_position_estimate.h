...
typedef struct __mavlink_global_vision_position_estimate_t {
 ...
 uint8_t padding[16]; /*< Padding for encryption*/
 uint8_t tag[16]; /*< 128 bit message signature*/
}) mavlink_global_vision_position_estimate_t;

#define MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_LEN 64
#define MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_MIN_LEN 64
#define MAVLINK_MSG_ID_101_LEN 64
#define MAVLINK_MSG_ID_101_MIN_LEN 64

#define MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE_CRC 142
#define MAVLINK_MSG_ID_101_CRC 142

#define MAVLINK_MSG_GLOBAL_VISION_POSITION_ESTIMATE_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_GLOBAL_VISION_POSITION_ESTIMATE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_VISION_POSITION_ESTIMATE { \
    ...
    {  { "usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_global_vision_position_estimate_t, usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_global_vision_position_estimate_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_global_vision_position_estimate_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GLOBAL_VISION_POSITION_ESTIMATE { \
                               ...
                               uint64_t usec, float x, float y, float z, float roll, float pitch, float yaw)
{
    ...
    _mav_put_uint8_t_array(buf, 48, NULL, 16);
    ...
    packet.pitch = pitch;
    packet.yaw = yaw;
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*16);
...
/**
 * @brief Get field padding from global_vision_position_estimate message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_global_vision_position_estimate_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  32);
}

/**
 * @brief Get field tag from global_vision_position_estimate message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_global_vision_position_estimate_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  48);
}
...
static inline void mavlink_msg_global_vision_position_estimate_decode(const mavlink_message_t* msg, mavlink_global_vision_position_estimate_t* global_vision_position_estimate)
{
    ...
    mavlink_msg_global_vision_position_estimate_get_padding(msg, global_vision_position_estimate->padding);
    mavlink_msg_global_vision_position_estimate_get_tag(msg, global_vision_position_estimate->tag);
#else
