...
#define MAVLINK_MSG_ID_GPS_RTCM_DATA_LEN 208
#define MAVLINK_MSG_ID_GPS_RTCM_DATA_MIN_LEN 208
#define MAVLINK_MSG_ID_233_LEN 208
#define MAVLINK_MSG_ID_233_MIN_LEN 208

#define MAVLINK_MSG_ID_GPS_RTCM_DATA_CRC 17
#define MAVLINK_MSG_ID_233_CRC 17

#define MAVLINK_MSG_GPS_RTCM_DATA_FIELD_DATA_LEN 180
#define MAVLINK_MSG_GPS_RTCM_DATA_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_GPS_RTCM_DATA_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GPS_RTCM_DATA { \
    ...
    {  { "flags", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_gps_rtcm_data_t, flags) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 182, offsetof(mavlink_gps_rtcm_data_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 192, offsetof(mavlink_gps_rtcm_data_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS_RTCM_DATA { \
                               ...
                               uint8_t flags, uint8_t len, const uint8_t *data)
{
    ...
    _mav_put_uint8_t_array(buf, 182, NULL, 10);
...
/**
 * @brief Get field padding from gps_rtcm_data message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps_rtcm_data_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  182);
}

/**
 * @brief Get field tag from gps_rtcm_data message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_gps_rtcm_data_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_gps_rtcm_data_decode(const mavlink_message_t* msg, mavlink_gps_rtcm_data_t* gps_rtcm_data)
{
    ...
    mavlink_msg_gps_rtcm_data_get_padding(msg, gps_rtcm_data->padding);
    mavlink_msg_gps_rtcm_data_get_tag(msg, gps_rtcm_data->tag);
#else
