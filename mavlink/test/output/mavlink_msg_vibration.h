...
#define MAVLINK_MSG_ID_VIBRATION_LEN 64
#define MAVLINK_MSG_ID_VIBRATION_MIN_LEN 64
#define MAVLINK_MSG_ID_241_LEN 64
#define MAVLINK_MSG_ID_241_MIN_LEN 64

#define MAVLINK_MSG_ID_VIBRATION_CRC 20
#define MAVLINK_MSG_ID_241_CRC 20

#define MAVLINK_MSG_VIBRATION_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_VIBRATION_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_VIBRATION { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_vibration_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_vibration_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_vibration_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_VIBRATION { \
...
/**
 * @brief Get field padding from vibration message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_vibration_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  32);
}

/**
 * @brief Get field tag from vibration message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_vibration_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_vibration_decode(const mavlink_message_t* msg, mavlink_vibration_t* vibration)
{
    ...
    mavlink_msg_vibration_get_padding(msg, vibration->padding);
    mavlink_msg_vibration_get_tag(msg, vibration->tag);
#else
