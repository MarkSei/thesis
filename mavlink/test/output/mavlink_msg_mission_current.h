...
#define MAVLINK_MSG_ID_MISSION_CURRENT_LEN 32
#define MAVLINK_MSG_ID_MISSION_CURRENT_MIN_LEN 32
#define MAVLINK_MSG_ID_42_LEN 32
#define MAVLINK_MSG_ID_42_MIN_LEN 32

#define MAVLINK_MSG_ID_MISSION_CURRENT_CRC 44
#define MAVLINK_MSG_ID_42_CRC 44

#define MAVLINK_MSG_MISSION_CURRENT_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_MISSION_CURRENT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MISSION_CURRENT { \
    ...
    {  { "seq", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_mission_current_t, seq) }, \
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 2, offsetof(mavlink_mission_current_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_mission_current_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_CURRENT { \
...
/**
 * @brief Get field padding from mission_current message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_current_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  2);
}

/**
 * @brief Get field tag from mission_current message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_mission_current_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_mission_current_decode(const mavlink_message_t* msg, mavlink_mission_current_t* mission_current)
{
    ...
    mavlink_msg_mission_current_get_padding(msg, mission_current->padding);
    mavlink_msg_mission_current_get_tag(msg, mission_current->tag);
#else
