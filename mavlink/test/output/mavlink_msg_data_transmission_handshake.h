...
typedef struct __mavlink_data_transmission_handshake_t {
 ...
 uint8_t padding[3]; /*< Padding for encryption*/
 uint8_t tag[16]; /*< 128 bit message signature*/
}) mavlink_data_transmission_handshake_t;

#define MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_LEN 32
#define MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_MIN_LEN 32
#define MAVLINK_MSG_ID_130_LEN 32
#define MAVLINK_MSG_ID_130_MIN_LEN 32

#define MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE_CRC 199
#define MAVLINK_MSG_ID_130_CRC 199

#define MAVLINK_MSG_DATA_TRANSMISSION_HANDSHAKE_FIELD_PADDING_LEN 3
#define MAVLINK_MSG_DATA_TRANSMISSION_HANDSHAKE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_DATA_TRANSMISSION_HANDSHAKE { \
    ...
    {  { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_data_transmission_handshake_t, type) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 3, 13, offsetof(mavlink_data_transmission_handshake_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_data_transmission_handshake_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_DATA_TRANSMISSION_HANDSHAKE { \
                               ...
                               uint8_t type, uint32_t size, uint16_t width, uint16_t height, uint16_t packets, uint8_t payload, uint8_t jpg_quality)
{
    ...
    _mav_put_uint8_t_array(buf, 13, NULL, 3);
    ...
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*3);
...
/**
 * @brief Get field padding from data_transmission_handshake message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_data_transmission_handshake_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 3,  13);
}

/**
 * @brief Get field tag from data_transmission_handshake message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_data_transmission_handshake_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_data_transmission_handshake_decode(const mavlink_message_t* msg, mavlink_data_transmission_handshake_t* data_transmission_handshake)
{
    ...
    mavlink_msg_data_transmission_handshake_get_padding(msg, data_transmission_handshake->padding);
    mavlink_msg_data_transmission_handshake_get_tag(msg, data_transmission_handshake->tag);
#else
