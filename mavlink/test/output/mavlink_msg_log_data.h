...
#define MAVLINK_MSG_ID_LOG_DATA_LEN 128
#define MAVLINK_MSG_ID_LOG_DATA_MIN_LEN 128
#define MAVLINK_MSG_ID_120_LEN 128
#define MAVLINK_MSG_ID_120_MIN_LEN 128

#define MAVLINK_MSG_ID_LOG_DATA_CRC 250
#define MAVLINK_MSG_ID_120_CRC 250

#define MAVLINK_MSG_LOG_DATA_FIELD_DATA_LEN 90
#define MAVLINK_MSG_LOG_DATA_FIELD_PADDING_LEN 15
#define MAVLINK_MSG_LOG_DATA_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_LOG_DATA { \
    ...
    {  { "id", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_log_data_t, id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 15, 97, offsetof(mavlink_log_data_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 112, offsetof(mavlink_log_data_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LOG_DATA { \
                               ...
                               uint16_t id, uint32_t ofs, uint8_t count, const uint8_t *data)
{
    ...
    _mav_put_uint8_t_array(buf, 97, NULL, 15);
...
/**
 * @brief Get field padding from log_data message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_log_data_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 15,  97);
}

/**
 * @brief Get field tag from log_data message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_log_data_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_log_data_decode(const mavlink_message_t* msg, mavlink_log_data_t* log_data)
{
    ...
    mavlink_msg_log_data_get_padding(msg, log_data->padding);
    mavlink_msg_log_data_get_tag(msg, log_data->tag);
#else
