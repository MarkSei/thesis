...
#define MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_LEN 48
#define MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_MIN_LEN 48
#define MAVLINK_MSG_ID_251_LEN 48
#define MAVLINK_MSG_ID_251_MIN_LEN 48

#define MAVLINK_MSG_ID_NAMED_VALUE_FLOAT_CRC 150
#define MAVLINK_MSG_ID_251_CRC 150

#define MAVLINK_MSG_NAMED_VALUE_FLOAT_FIELD_NAME_LEN 10
#define MAVLINK_MSG_NAMED_VALUE_FLOAT_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_NAMED_VALUE_FLOAT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_FLOAT { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_named_value_float_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 18, offsetof(mavlink_named_value_float_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_named_value_float_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_NAMED_VALUE_FLOAT { \
...
/**
 * @brief Get field padding from named_value_float message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_named_value_float_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  18);
}

/**
 * @brief Get field tag from named_value_float message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_named_value_float_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_named_value_float_decode(const mavlink_message_t* msg, mavlink_named_value_float_t* named_value_float)
{
    ...
    mavlink_msg_named_value_float_get_padding(msg, named_value_float->padding);
    mavlink_msg_named_value_float_get_tag(msg, named_value_float->tag);
#else
