...
typedef struct __mavlink_set_position_target_global_int_t {
 ...
 uint8_t padding[11]; /*< Padding for encryption*/
 uint8_t tag[16]; /*< 128 bit message signature*/
}) mavlink_set_position_target_global_int_t;

#define MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_LEN 80
#define MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_MIN_LEN 80
#define MAVLINK_MSG_ID_86_LEN 80
#define MAVLINK_MSG_ID_86_MIN_LEN 80

#define MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT_CRC 142
#define MAVLINK_MSG_ID_86_CRC 142

#define MAVLINK_MSG_SET_POSITION_TARGET_GLOBAL_INT_FIELD_PADDING_LEN 11
#define MAVLINK_MSG_SET_POSITION_TARGET_GLOBAL_INT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_GLOBAL_INT { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_set_position_target_global_int_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 53, offsetof(mavlink_set_position_target_global_int_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_set_position_target_global_int_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_GLOBAL_INT { \
                               ...
                               uint32_t time_boot_ms, uint8_t target_system, uint8_t target_component, uint8_t coordinate_frame, uint16_t type_mask, int32_t lat_int, int32_t lon_int, float alt, float vx, float vy, float vz, float afx, float afy, float afz, float yaw, float yaw_rate)
{
    ...
    _mav_put_uint8_t_array(buf, 53, NULL, 11);
    _mav_put_uint8_t_array(buf, 64, NULL, 16);
    ...
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*11);
...
/**
 * @brief Get field padding from set_position_target_global_int message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_set_position_target_global_int_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  53);
}

/**
 * @brief Get field tag from set_position_target_global_int message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_set_position_target_global_int_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  64);
}
...
static inline void mavlink_msg_set_position_target_global_int_decode(const mavlink_message_t* msg, mavlink_set_position_target_global_int_t* set_position_target_global_int)
{
    ...
    mavlink_msg_set_position_target_global_int_get_padding(msg, set_position_target_global_int->padding);
    mavlink_msg_set_position_target_global_int_get_tag(msg, set_position_target_global_int->tag);
#else
