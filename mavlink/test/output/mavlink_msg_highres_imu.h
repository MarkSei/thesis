...
#define MAVLINK_MSG_ID_HIGHRES_IMU_LEN 80
#define MAVLINK_MSG_ID_HIGHRES_IMU_MIN_LEN 80
#define MAVLINK_MSG_ID_105_LEN 80
#define MAVLINK_MSG_ID_105_MIN_LEN 80

#define MAVLINK_MSG_ID_HIGHRES_IMU_CRC 76
#define MAVLINK_MSG_ID_105_CRC 76

#define MAVLINK_MSG_HIGHRES_IMU_FIELD_PADDING_LEN 2
#define MAVLINK_MSG_HIGHRES_IMU_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIGHRES_IMU { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_highres_imu_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 2, 62, offsetof(mavlink_highres_imu_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_highres_imu_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIGHRES_IMU { \
                               ...
                               uint64_t time_usec, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro, float xmag, float ymag, float zmag, float abs_pressure, float diff_pressure, float pressure_alt, float temperature, uint16_t fields_updated)
{
    ...
    _mav_put_uint8_t_array(buf, 62, NULL, 2);
...
/**
 * @brief Get field padding from highres_imu message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_highres_imu_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 2,  62);
}

/**
 * @brief Get field tag from highres_imu message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_highres_imu_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_highres_imu_decode(const mavlink_message_t* msg, mavlink_highres_imu_t* highres_imu)
{
    ...
    mavlink_msg_highres_imu_get_padding(msg, highres_imu->padding);
    mavlink_msg_highres_imu_get_tag(msg, highres_imu->tag);
#else
