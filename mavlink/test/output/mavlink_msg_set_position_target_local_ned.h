...
#define MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_LEN 80
#define MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_MIN_LEN 80
#define MAVLINK_MSG_ID_84_LEN 80
#define MAVLINK_MSG_ID_84_MIN_LEN 80

#define MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED_CRC 179
#define MAVLINK_MSG_ID_84_CRC 179

#define MAVLINK_MSG_SET_POSITION_TARGET_LOCAL_NED_FIELD_PADDING_LEN 11
#define MAVLINK_MSG_SET_POSITION_TARGET_LOCAL_NED_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_LOCAL_NED { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_set_position_target_local_ned_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 53, offsetof(mavlink_set_position_target_local_ned_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_set_position_target_local_ned_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_POSITION_TARGET_LOCAL_NED { \
...
/**
 * @brief Get field padding from set_position_target_local_ned message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_set_position_target_local_ned_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  53);
}

/**
 * @brief Get field tag from set_position_target_local_ned message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_set_position_target_local_ned_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_set_position_target_local_ned_decode(const mavlink_message_t* msg, mavlink_set_position_target_local_ned_t* set_position_target_local_ned)
{
    ...
    mavlink_msg_set_position_target_local_ned_get_padding(msg, set_position_target_local_ned->padding);
    mavlink_msg_set_position_target_local_ned_get_tag(msg, set_position_target_local_ned->tag);
#else
