...
#define MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_LEN 112
#define MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_MIN_LEN 112
#define MAVLINK_MSG_ID_93_LEN 112
#define MAVLINK_MSG_ID_93_MIN_LEN 112

#define MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS_CRC 126
#define MAVLINK_MSG_ID_93_CRC 126

#define MAVLINK_MSG_HIL_ACTUATOR_CONTROLS_FIELD_CONTROLS_LEN 16
#define MAVLINK_MSG_HIL_ACTUATOR_CONTROLS_FIELD_PADDING_LEN 15
#define MAVLINK_MSG_HIL_ACTUATOR_CONTROLS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_ACTUATOR_CONTROLS { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_actuator_controls_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 15, 81, offsetof(mavlink_hil_actuator_controls_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 96, offsetof(mavlink_hil_actuator_controls_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_ACTUATOR_CONTROLS { \
                               ...
                               uint64_t time_usec, const float *controls, uint8_t mode, uint64_t flags)
{
    ...
    _mav_put_uint8_t_array(buf, 81, NULL, 15);
    _mav_put_uint8_t_array(buf, 96, NULL, 16);
...
/**
 * @brief Get field padding from hil_actuator_controls message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_actuator_controls_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 15,  81);
}

/**
 * @brief Get field tag from hil_actuator_controls message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_actuator_controls_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  96);
}
...
static inline void mavlink_msg_hil_actuator_controls_decode(const mavlink_message_t* msg, mavlink_hil_actuator_controls_t* hil_actuator_controls)
{
    ...
    mavlink_msg_hil_actuator_controls_get_padding(msg, hil_actuator_controls->padding);
    mavlink_msg_hil_actuator_controls_get_tag(msg, hil_actuator_controls->tag);
#else
