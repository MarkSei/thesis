...
#define MAVLINK_MSG_ID_HIL_SENSOR_LEN 96
#define MAVLINK_MSG_ID_HIL_SENSOR_MIN_LEN 96
#define MAVLINK_MSG_ID_107_LEN 96
#define MAVLINK_MSG_ID_107_MIN_LEN 96

#define MAVLINK_MSG_ID_HIL_SENSOR_CRC 209
#define MAVLINK_MSG_ID_107_CRC 209

#define MAVLINK_MSG_HIL_SENSOR_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_HIL_SENSOR_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_HIL_SENSOR { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_sensor_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_hil_sensor_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 80, offsetof(mavlink_hil_sensor_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_SENSOR { \
...
/**
 * @brief Get field padding from hil_sensor message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_hil_sensor_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  64);
}

/**
 * @brief Get field tag from hil_sensor message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_hil_sensor_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_hil_sensor_decode(const mavlink_message_t* msg, mavlink_hil_sensor_t* hil_sensor)
{
    ...
    mavlink_msg_hil_sensor_get_padding(msg, hil_sensor->padding);
    mavlink_msg_hil_sensor_get_tag(msg, hil_sensor->tag);
#else
