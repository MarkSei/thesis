...
#define MAVLINK_MSG_ID_SYS_STATUS_CRC 244
#define MAVLINK_MSG_ID_1_CRC 244

#define MAVLINK_MSG_SYS_STATUS_FIELD_PADDING_LEN 1
#define MAVLINK_MSG_SYS_STATUS_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
    ...
    {  { "onboard_control_sensors_present", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_sys_status_t, onboard_control_sensors_present) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 1, 31, offsetof(mavlink_sys_status_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_sys_status_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
                               ...
                               uint32_t onboard_control_sensors_present, uint32_t onboard_control_sensors_enabled, uint32_t onboard_control_sensors_health, uint16_t load, uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining, uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t errors_count1, uint16_t errors_count2, uint16_t errors_count3, uint16_t errors_count4)
{
    ...
    _mav_put_uint8_t_array(buf, 31, NULL, 1);
...
/**
 * @brief Get field padding from sys_status message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_sys_status_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 1,  31);
}

/**
 * @brief Get field tag from sys_status message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_sys_status_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_sys_status_decode(const mavlink_message_t* msg, mavlink_sys_status_t* sys_status)
{
    ...
    mavlink_msg_sys_status_get_padding(msg, sys_status->padding);
    mavlink_msg_sys_status_get_tag(msg, sys_status->tag);
#else
