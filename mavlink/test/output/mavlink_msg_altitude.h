...
#define MAVLINK_MSG_ID_ALTITUDE_LEN 64
#define MAVLINK_MSG_ID_ALTITUDE_MIN_LEN 64
#define MAVLINK_MSG_ID_141_LEN 64
#define MAVLINK_MSG_ID_141_MIN_LEN 64

#define MAVLINK_MSG_ID_ALTITUDE_CRC 138
#define MAVLINK_MSG_ID_141_CRC 138

#define MAVLINK_MSG_ALTITUDE_FIELD_PADDING_LEN 16
#define MAVLINK_MSG_ALTITUDE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ALTITUDE { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_altitude_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_altitude_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_altitude_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ALTITUDE { \
...
/**
 * @brief Get field padding from altitude message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_altitude_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 16,  32);
}

/**
 * @brief Get field tag from altitude message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_altitude_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_altitude_decode(const mavlink_message_t* msg, mavlink_altitude_t* altitude)
{
    ...
    mavlink_msg_altitude_get_padding(msg, altitude->padding);
    mavlink_msg_altitude_get_tag(msg, altitude->tag);
#else
