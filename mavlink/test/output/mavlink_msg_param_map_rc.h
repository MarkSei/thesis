...
#define MAVLINK_MSG_ID_PARAM_MAP_RC_LEN 64
#define MAVLINK_MSG_ID_PARAM_MAP_RC_MIN_LEN 64
#define MAVLINK_MSG_ID_50_LEN 64
#define MAVLINK_MSG_ID_50_MIN_LEN 64

#define MAVLINK_MSG_ID_PARAM_MAP_RC_CRC 46
#define MAVLINK_MSG_ID_50_CRC 46

#define MAVLINK_MSG_PARAM_MAP_RC_FIELD_PARAM_ID_LEN 16
#define MAVLINK_MSG_PARAM_MAP_RC_FIELD_PADDING_LEN 11
#define MAVLINK_MSG_PARAM_MAP_RC_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_PARAM_MAP_RC { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 18, offsetof(mavlink_param_map_rc_t, target_system) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 11, 37, offsetof(mavlink_param_map_rc_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_param_map_rc_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_MAP_RC { \
                               ...
                               uint8_t target_system, uint8_t target_component, const char *param_id, int16_t param_index, uint8_t parameter_rc_channel_index, float param_value0, float scale, float param_value_min, float param_value_max)
{
    ...
    _mav_put_uint8_t_array(buf, 37, NULL, 11);
...
/**
 * @brief Get field padding from param_map_rc message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_param_map_rc_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 11,  37);
}

/**
 * @brief Get field tag from param_map_rc message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_param_map_rc_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_param_map_rc_decode(const mavlink_message_t* msg, mavlink_param_map_rc_t* param_map_rc)
{
    ...
    mavlink_msg_param_map_rc_get_padding(msg, param_map_rc->padding);
    mavlink_msg_param_map_rc_get_tag(msg, param_map_rc->tag);
#else
