...
#define MAVLINK_MSG_ID_PING_LEN 32
#define MAVLINK_MSG_ID_PING_MIN_LEN 32
#define MAVLINK_MSG_ID_4_LEN 32
#define MAVLINK_MSG_ID_4_MIN_LEN 32

#define MAVLINK_MSG_ID_PING_CRC 95
#define MAVLINK_MSG_ID_4_CRC 95

#define MAVLINK_MSG_PING_FIELD_PADDING_LEN 2
#define MAVLINK_MSG_PING_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_PING { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_ping_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 2, 14, offsetof(mavlink_ping_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_ping_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PING { \
...
/**
 * @brief Get field padding from ping message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_ping_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 2,  14);
}

/**
 * @brief Get field tag from ping message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_ping_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_ping_decode(const mavlink_message_t* msg, mavlink_ping_t* ping)
{
    ...
    mavlink_msg_ping_get_padding(msg, ping->padding);
    mavlink_msg_ping_get_tag(msg, ping->tag);
#else
