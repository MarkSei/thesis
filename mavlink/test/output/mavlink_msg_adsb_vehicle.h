...
#define MAVLINK_MSG_ID_ADSB_VEHICLE_LEN 64
#define MAVLINK_MSG_ID_ADSB_VEHICLE_MIN_LEN 64
#define MAVLINK_MSG_ID_246_LEN 64
#define MAVLINK_MSG_ID_246_MIN_LEN 64

#define MAVLINK_MSG_ID_ADSB_VEHICLE_CRC 186
#define MAVLINK_MSG_ID_246_CRC 186

#define MAVLINK_MSG_ADSB_VEHICLE_FIELD_CALLSIGN_LEN 9
#define MAVLINK_MSG_ADSB_VEHICLE_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_ADSB_VEHICLE_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_ADSB_VEHICLE { \
    ...
    {  { "ICAO_address", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_adsb_vehicle_t, ICAO_address) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 38, offsetof(mavlink_adsb_vehicle_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_adsb_vehicle_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ADSB_VEHICLE { \
                               ...
                               uint32_t ICAO_address, int32_t lat, int32_t lon, uint8_t altitude_type, int32_t altitude, uint16_t heading, uint16_t hor_velocity, int16_t ver_velocity, const char *callsign, uint8_t emitter_type, uint8_t tslc, uint16_t flags, uint16_t squawk)
{
    ...
    _mav_put_uint8_t_array(buf, 38, NULL, 10);
...
/**
 * @brief Get field padding from adsb_vehicle message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_adsb_vehicle_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  38);
}

/**
 * @brief Get field tag from adsb_vehicle message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_adsb_vehicle_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_adsb_vehicle_decode(const mavlink_message_t* msg, mavlink_adsb_vehicle_t* adsb_vehicle)
{
    ...
    mavlink_msg_adsb_vehicle_get_padding(msg, adsb_vehicle->padding);
    mavlink_msg_adsb_vehicle_get_tag(msg, adsb_vehicle->tag);
#else
