...
typedef struct __mavlink_set_attitude_target_t {
 ...
 uint8_t padding[9]; /*< Padding for encryption*/
 uint8_t tag[16]; /*< 128 bit message signature*/
}) mavlink_set_attitude_target_t;

#define MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_LEN 64
#define MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_MIN_LEN 64
#define MAVLINK_MSG_ID_82_LEN 64
#define MAVLINK_MSG_ID_82_MIN_LEN 64

#define MAVLINK_MSG_ID_SET_ATTITUDE_TARGET_CRC 120
#define MAVLINK_MSG_ID_82_CRC 120

#define MAVLINK_MSG_SET_ATTITUDE_TARGET_FIELD_Q_LEN 4
#define MAVLINK_MSG_SET_ATTITUDE_TARGET_FIELD_PADDING_LEN 9
#define MAVLINK_MSG_SET_ATTITUDE_TARGET_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SET_ATTITUDE_TARGET { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_set_attitude_target_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 9, 39, offsetof(mavlink_set_attitude_target_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_set_attitude_target_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_ATTITUDE_TARGET { \
                               ...
                               uint32_t time_boot_ms, uint8_t target_system, uint8_t target_component, uint8_t type_mask, const float *q, float body_roll_rate, float body_pitch_rate, float body_yaw_rate, float thrust)
{
    ...
    _mav_put_uint8_t_array(buf, 39, NULL, 9);
    ...
    mav_array_memcpy(packet.padding, NULL, sizeof(uint8_t)*9);
...
/**
 * @brief Get field padding from set_attitude_target message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_set_attitude_target_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 9,  39);
}

/**
 * @brief Get field tag from set_attitude_target message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_set_attitude_target_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_set_attitude_target_decode(const mavlink_message_t* msg, mavlink_set_attitude_target_t* set_attitude_target)
{
    ...
    mavlink_msg_set_attitude_target_get_padding(msg, set_attitude_target->padding);
    mavlink_msg_set_attitude_target_get_tag(msg, set_attitude_target->tag);
#else
