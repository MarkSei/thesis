...
#define MAVLINK_MSG_ID_SCALED_IMU3_LEN 48
#define MAVLINK_MSG_ID_SCALED_IMU3_MIN_LEN 48
#define MAVLINK_MSG_ID_129_LEN 48
#define MAVLINK_MSG_ID_129_MIN_LEN 48

#define MAVLINK_MSG_ID_SCALED_IMU3_CRC 35
#define MAVLINK_MSG_ID_129_CRC 35

#define MAVLINK_MSG_SCALED_IMU3_FIELD_PADDING_LEN 10
#define MAVLINK_MSG_SCALED_IMU3_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_SCALED_IMU3 { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_scaled_imu3_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 10, 22, offsetof(mavlink_scaled_imu3_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_scaled_imu3_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SCALED_IMU3 { \
...
/**
 * @brief Get field padding from scaled_imu3 message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_scaled_imu3_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 10,  22);
}

/**
 * @brief Get field tag from scaled_imu3 message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_scaled_imu3_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_scaled_imu3_decode(const mavlink_message_t* msg, mavlink_scaled_imu3_t* scaled_imu3)
{
    ...
    mavlink_msg_scaled_imu3_get_padding(msg, scaled_imu3->padding);
    mavlink_msg_scaled_imu3_get_tag(msg, scaled_imu3->tag);
#else
