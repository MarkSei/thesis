...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_LEN 64
#define MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_MIN_LEN 64
#define MAVLINK_MSG_ID_106_LEN 64
#define MAVLINK_MSG_ID_106_MIN_LEN 64

#define MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_CRC 218
#define MAVLINK_MSG_ID_106_CRC 218

#define MAVLINK_MSG_OPTICAL_FLOW_RAD_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_OPTICAL_FLOW_RAD_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_OPTICAL_FLOW_RAD { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_optical_flow_rad_t, time_usec) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 44, offsetof(mavlink_optical_flow_rad_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_optical_flow_rad_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPTICAL_FLOW_RAD { \
                               ...
                               uint64_t time_usec, uint8_t sensor_id, uint32_t integration_time_us, float integrated_x, float integrated_y, float integrated_xgyro, float integrated_ygyro, float integrated_zgyro, int16_t temperature, uint8_t quality, uint32_t time_delta_distance_us, float distance)
{
    ...
    _mav_put_uint8_t_array(buf, 44, NULL, 4);
...
/**
 * @brief Get field padding from optical_flow_rad message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_optical_flow_rad_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  44);
}

/**
 * @brief Get field tag from optical_flow_rad message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_optical_flow_rad_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_optical_flow_rad_decode(const mavlink_message_t* msg, mavlink_optical_flow_rad_t* optical_flow_rad)
{
    ...
    mavlink_msg_optical_flow_rad_get_padding(msg, optical_flow_rad->padding);
    mavlink_msg_optical_flow_rad_get_tag(msg, optical_flow_rad->tag);
#else
