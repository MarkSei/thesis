...
#define MAVLINK_MSG_ID_TERRAIN_DATA_LEN 64
#define MAVLINK_MSG_ID_TERRAIN_DATA_MIN_LEN 64
#define MAVLINK_MSG_ID_134_LEN 64
#define MAVLINK_MSG_ID_134_MIN_LEN 64

#define MAVLINK_MSG_ID_TERRAIN_DATA_CRC 210
#define MAVLINK_MSG_ID_134_CRC 210

#define MAVLINK_MSG_TERRAIN_DATA_FIELD_DATA_LEN 16
#define MAVLINK_MSG_TERRAIN_DATA_FIELD_PADDING_LEN 5
#define MAVLINK_MSG_TERRAIN_DATA_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_TERRAIN_DATA { \
    ...
    {  { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_terrain_data_t, lat) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 5, 43, offsetof(mavlink_terrain_data_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_terrain_data_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TERRAIN_DATA { \
...
/**
 * @brief Get field padding from terrain_data message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_terrain_data_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 5,  43);
}

/**
 * @brief Get field tag from terrain_data message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_terrain_data_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_terrain_data_decode(const mavlink_message_t* msg, mavlink_terrain_data_t* terrain_data)
{
    ...
    mavlink_msg_terrain_data_get_padding(msg, terrain_data->padding);
    mavlink_msg_terrain_data_get_tag(msg, terrain_data->tag);
#else
