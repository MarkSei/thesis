...
#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_LEN 32
#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_MIN_LEN 32
#define MAVLINK_MSG_ID_6_LEN 32
#define MAVLINK_MSG_ID_6_MIN_LEN 32

#define MAVLINK_MSG_ID_CHANGE_OPERATOR_CONTROL_ACK_CRC 244
#define MAVLINK_MSG_ID_6_CRC 244

#define MAVLINK_MSG_CHANGE_OPERATOR_CONTROL_ACK_FIELD_PADDING_LEN 13
#define MAVLINK_MSG_CHANGE_OPERATOR_CONTROL_ACK_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_CHANGE_OPERATOR_CONTROL_ACK { \
    ...
    {  { "gcs_system_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_change_operator_control_ack_t, gcs_system_id) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 3, offsetof(mavlink_change_operator_control_ack_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_change_operator_control_ack_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_CHANGE_OPERATOR_CONTROL_ACK { \
                               ...
                               uint8_t gcs_system_id, uint8_t control_request, uint8_t ack)
{
    ...
    _mav_put_uint8_t_array(buf, 3, NULL, 13);
...
/**
 * @brief Get field padding from change_operator_control_ack message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_change_operator_control_ack_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  3);
}

/**
 * @brief Get field tag from change_operator_control_ack message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_change_operator_control_ack_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_change_operator_control_ack_decode(const mavlink_message_t* msg, mavlink_change_operator_control_ack_t* change_operator_control_ack)
{
    ...
    mavlink_msg_change_operator_control_ack_get_padding(msg, change_operator_control_ack->padding);
    mavlink_msg_change_operator_control_ack_get_tag(msg, change_operator_control_ack->tag);
#else
