...
#define MAVLINK_MSG_ID_MISSION_ITEM_REACHED_LEN 32
#define MAVLINK_MSG_ID_MISSION_ITEM_REACHED_MIN_LEN 32
#define MAVLINK_MSG_ID_46_LEN 32
#define MAVLINK_MSG_ID_46_MIN_LEN 32

#define MAVLINK_MSG_ID_MISSION_ITEM_REACHED_CRC 179
#define MAVLINK_MSG_ID_46_CRC 179

#define MAVLINK_MSG_MISSION_ITEM_REACHED_FIELD_PADDING_LEN 14
#define MAVLINK_MSG_MISSION_ITEM_REACHED_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM_REACHED { \
    ...
    {  { "seq", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_mission_item_reached_t, seq) }, \
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 14, 2, offsetof(mavlink_mission_item_reached_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 16, offsetof(mavlink_mission_item_reached_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_ITEM_REACHED { \
...
/**
 * @brief Get field padding from mission_item_reached message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_mission_item_reached_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 14,  2);
}

/**
 * @brief Get field tag from mission_item_reached message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_mission_item_reached_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_mission_item_reached_decode(const mavlink_message_t* msg, mavlink_mission_item_reached_t* mission_item_reached)
{
    ...
    mavlink_msg_mission_item_reached_get_padding(msg, mission_item_reached->padding);
    mavlink_msg_mission_item_reached_get_tag(msg, mission_item_reached->tag);
#else
