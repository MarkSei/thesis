...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_MIN_LEN 48
#define MAVLINK_MSG_ID_33_LEN 48
#define MAVLINK_MSG_ID_33_MIN_LEN 48

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC 241
#define MAVLINK_MSG_ID_33_CRC 241

#define MAVLINK_MSG_GLOBAL_POSITION_INT_FIELD_PADDING_LEN 4
#define MAVLINK_MSG_GLOBAL_POSITION_INT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_global_position_int_t, time_boot_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 4, 28, offsetof(mavlink_global_position_int_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_global_position_int_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
...
/**
 * @brief Get field padding from global_position_int message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_global_position_int_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 4,  28);
}

/**
 * @brief Get field tag from global_position_int message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_global_position_int_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_global_position_int_decode(const mavlink_message_t* msg, mavlink_global_position_int_t* global_position_int)
{
    ...
    mavlink_msg_global_position_int_get_padding(msg, global_position_int->padding);
    mavlink_msg_global_position_int_get_tag(msg, global_position_int->tag);
#else
