...
#define MAVLINK_MSG_ID_DEBUG_VECT_LEN 48
#define MAVLINK_MSG_ID_DEBUG_VECT_MIN_LEN 48
#define MAVLINK_MSG_ID_250_LEN 48
#define MAVLINK_MSG_ID_250_MIN_LEN 48

#define MAVLINK_MSG_ID_DEBUG_VECT_CRC 94
#define MAVLINK_MSG_ID_250_CRC 94

#define MAVLINK_MSG_DEBUG_VECT_FIELD_NAME_LEN 10
#define MAVLINK_MSG_DEBUG_VECT_FIELD_PADDING_LEN 2
#define MAVLINK_MSG_DEBUG_VECT_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_DEBUG_VECT { \
    ...
    {  { "name", NULL, MAVLINK_TYPE_CHAR, 10, 20, offsetof(mavlink_debug_vect_t, name) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 2, 30, offsetof(mavlink_debug_vect_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 32, offsetof(mavlink_debug_vect_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_DEBUG_VECT { \
                               ...
                               const char *name, uint64_t time_usec, float x, float y, float z)
{
    ...
    _mav_put_uint8_t_array(buf, 30, NULL, 2);
...
/**
 * @brief Get field padding from debug_vect message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_debug_vect_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 2,  30);
}

/**
 * @brief Get field tag from debug_vect message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_debug_vect_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_debug_vect_decode(const mavlink_message_t* msg, mavlink_debug_vect_t* debug_vect)
{
    ...
    mavlink_msg_debug_vect_get_padding(msg, debug_vect->padding);
    mavlink_msg_debug_vect_get_tag(msg, debug_vect->tag);
#else
