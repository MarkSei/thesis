...
#define MAVLINK_MSG_ID_GPS2_RTK_LEN 64
#define MAVLINK_MSG_ID_GPS2_RTK_MIN_LEN 64
#define MAVLINK_MSG_ID_128_LEN 64
#define MAVLINK_MSG_ID_128_MIN_LEN 64

#define MAVLINK_MSG_ID_GPS2_RTK_CRC 135
#define MAVLINK_MSG_ID_128_CRC 135

#define MAVLINK_MSG_GPS2_RTK_FIELD_PADDING_LEN 13
#define MAVLINK_MSG_GPS2_RTK_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_GPS2_RTK { \
    ...
    {  { "time_last_baseline_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_gps2_rtk_t, time_last_baseline_ms) }, \
         ...
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 13, 35, offsetof(mavlink_gps2_rtk_t, padding) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 48, offsetof(mavlink_gps2_rtk_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GPS2_RTK { \
...
/**
 * @brief Get field padding from gps2_rtk message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_gps2_rtk_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 13,  35);
}

/**
 * @brief Get field tag from gps2_rtk message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_gps2_rtk_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_gps2_rtk_decode(const mavlink_message_t* msg, mavlink_gps2_rtk_t* gps2_rtk)
{
    ...
    mavlink_msg_gps2_rtk_get_padding(msg, gps2_rtk->padding);
    mavlink_msg_gps2_rtk_get_tag(msg, gps2_rtk->tag);
#else
