                               ...
                               uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status)
{
    ...
    uint8_t ntag[16], npadding[7];
    memset(ntag, 0x00, 16);
    memset(npadding, 0x00, 7);

    _mav_put_uint8_t_array(buf, 9, npadding, 7);
    _mav_put_uint8_t_array(buf, 16, ntag, 16);
    ...
    memset(ntag, 0x00, 16);
    memset(npadding, 0x00, 7);
    mav_array_memcpy(packet.padding, npadding, sizeof(uint8_t)*7);
    mav_array_memcpy(packet.tag, ntag, sizeof(uint8_t)*16);
