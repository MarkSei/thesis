...
typedef struct __mavlink_heartbeat_t {
 ...
 uint8_t padding[7]; /*< Padding for encryption*/
}) mavlink_heartbeat_t;

#define MAVLINK_MSG_ID_HEARTBEAT_LEN 32
#define MAVLINK_MSG_ID_HEARTBEAT_MIN_LEN 32
#define MAVLINK_MSG_ID_0_LEN 32
#define MAVLINK_MSG_ID_0_MIN_LEN 32

#define MAVLINK_MSG_ID_HEARTBEAT_CRC 98
#define MAVLINK_MSG_ID_0_CRC 98

#define MAVLINK_MSG_HEARTBEAT_FIELD_TAG_LEN 16
#define MAVLINK_MSG_HEARTBEAT_FIELD_PADDING_LEN 7
...
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
    ...
    {  { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_heartbeat_t, type) }, \
         ...
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 9, offsetof(mavlink_heartbeat_t, tag) }, \
         { "padding", NULL, MAVLINK_TYPE_UINT8_T, 7, 25, offsetof(mavlink_heartbeat_t, padding) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
 ...
 * @param tag 128 bit message signature
 * @param padding Padding for encryption
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_heartbeat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status, const uint8_t *tag, const uint8_t *padding)
{
    ...
    _mav_put_uint8_t_array(buf, 9, tag, 16);
    _mav_put_uint8_t_array(buf, 25, padding, 7);
    ...
    mav_array_memcpy(packet.tag, tag, sizeof(uint8_t)*16);
    mav_array_memcpy(packet.padding, padding, sizeof(uint8_t)*7);
...
{
    return mavlink_msg_heartbeat_pack(system_id, component_id, msg, heartbeat->type, heartbeat->autopilot, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status, heartbeat->tag, heartbeat->padding);
}
...
{
    return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, heartbeat->type, heartbeat->autopilot, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status, heartbeat->tag, heartbeat->padding);
}
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan, uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status, const uint8_t *tag, const uint8_t *padding)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HEARTBEAT_LEN];
    _mav_put_uint32_t(buf, 0, custom_mode);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_heartbeat_send(chan, heartbeat->type, heartbeat->autopilot, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status, heartbeat->tag, heartbeat->padding);
#else
 ...
 */
static inline void mavlink_msg_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status, const uint8_t *tag, const uint8_t *padding)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field tag from heartbeat message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_heartbeat_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
    return _MAV_RETURN_uint8_t_array(msg, tag, 16,  9);
}

/**
 * @brief Get field padding from heartbeat message
 *
 * @return Padding for encryption
 */
static inline uint16_t mavlink_msg_heartbeat_get_padding(const mavlink_message_t* msg, uint8_t *padding)
{
    return _MAV_RETURN_uint8_t_array(msg, padding, 7,  25);
}
...
static inline void mavlink_msg_heartbeat_decode(const mavlink_message_t* msg, mavlink_heartbeat_t* heartbeat)
{
    ...
    mavlink_msg_heartbeat_get_tag(msg, heartbeat->tag);
    mavlink_msg_heartbeat_get_padding(msg, heartbeat->padding);
#else
