...
#define MAVLINK_MSG_ID_TEST-64-BYTES_LEN 80
#define MAVLINK_MSG_ID_TEST-64-BYTES_MIN_LEN 80
#define MAVLINK_MSG_ID_2_LEN 80
#define MAVLINK_MSG_ID_2_MIN_LEN 80

#define MAVLINK_MSG_ID_TEST-64-BYTES_CRC 237
#define MAVLINK_MSG_ID_2_CRC 237

#define MAVLINK_MSG_TEST-64-BYTES_FIELD_U8_ARRAY_LEN 64
#define MAVLINK_MSG_TEST-64-BYTES_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_TEST-64-BYTES { \
    ...
    {  { "u8_array", NULL, MAVLINK_TYPE_UINT8_T, 64, 0, offsetof(mavlink_test-64-bytes_t, u8_array) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 64, offsetof(mavlink_test-64-bytes_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TEST-64-BYTES { \
...
/**
 * @brief Get field tag from test-64-bytes message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_test-64-bytes_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_test-64-bytes_decode(const mavlink_message_t* msg, mavlink_test-64-bytes_t* test-64-bytes)
{
    ...
    mavlink_msg_test-64-bytes_get_tag(msg, test-64-bytes->tag);
#else
