...
#define MAVLINK_MSG_ID_TEST-128-BYTES_LEN 144
#define MAVLINK_MSG_ID_TEST-128-BYTES_MIN_LEN 144
#define MAVLINK_MSG_ID_3_LEN 144
#define MAVLINK_MSG_ID_3_MIN_LEN 144

#define MAVLINK_MSG_ID_TEST-128-BYTES_CRC 136
#define MAVLINK_MSG_ID_3_CRC 136

#define MAVLINK_MSG_TEST-128-BYTES_FIELD_U8_ARRAY_LEN 128
#define MAVLINK_MSG_TEST-128-BYTES_FIELD_TAG_LEN 16
...
#define MAVLINK_MESSAGE_INFO_TEST-128-BYTES { \
    ...
    {  { "u8_array", NULL, MAVLINK_TYPE_UINT8_T, 128, 0, offsetof(mavlink_test-128-bytes_t, u8_array) }, \
         { "tag", NULL, MAVLINK_TYPE_UINT8_T, 16, 128, offsetof(mavlink_test-128-bytes_t, tag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TEST-128-BYTES { \
...
/**
 * @brief Get field tag from test-128-bytes message
 *
 * @return 128 bit message signature
 */
static inline uint16_t mavlink_msg_test-128-bytes_get_tag(const mavlink_message_t* msg, uint8_t *tag)
{
...
static inline void mavlink_msg_test-128-bytes_decode(const mavlink_message_t* msg, mavlink_test-128-bytes_t* test-128-bytes)
{
    ...
    mavlink_msg_test-128-bytes_get_tag(msg, test-128-bytes->tag);
#else
